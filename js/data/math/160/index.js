...
window.check_160_1 = function() {
    ...
    const studentAns = window._sel160_1 ? window._sel160_1 + ". " + (window._sel160_1 === 'C' ? "13/19" : "") : "Chưa chọn";
    window.showMathFeedback(isCorrect,
        "C. 13/19",
        studentAns,
        "Gợi ý: Tỉ số của số chọn lên rừng (13 bạn) và số chọn xuống biển (19 bạn) được viết dưới dạng phân số với số bạn lên rừng là tử số và số bạn chọn xuống biển là mẫu số.<br>Em hãy kiểm tra lại tử số và mẫu số nhé!",
        "Tỉ số của số bạn chọn lên rừng và số bạn chọn xuống biển là: 13 : 19 hay 13/19.<br>Vậy đáp án đúng là C. 13/19.<br>Chúc mừng em đã chọn đúng!"
    );
...
window.check_160_2 = function() {
    ...
    const studentAns = `5A: ${v1 || '?'} quyển; 5B: ${v2 || '?'} quyển`;
    window.showMathFeedback(isCorrect,
        "Lớp 5A: 70 quyển; Lớp 5B: 56 quyển",
        studentAns,
        "Gợi ý: Đây là bài toán tìm hai số khi biết tổng và tỉ số.<br>Bước 1: Tìm tổng số phần bằng nhau (5 + 4 = 9 phần).<br>Bước 2: Tìm giá trị một phần bằng cách lấy tổng chia cho tổng số phần.<br>Bước 3: Nhân giá trị một phần với số phần tương ứng của từng lớp.",
        "Tổng số phần bằng nhau là: 5 + 4 = 9 (phần).<br>Lớp 5A quyên góp được: 126 : 9 × 5 = 70 (quyển).<br>Lớp 5B quyên góp được: 126 : 9 × 4 = 56 (quyển).<br>Đáp số: 5A: 70 quyển; 5B: 56 quyển.<br>Chúc mừng em đã làm bài xuất sắc!"
    );
...
window.check_160_3 = function() {
    ...
    const studentAns = `a) ${v1 || '?'} m; b) ${v2 || '?'} m`;
    window.showMathFeedback(isCorrect,
        "a) 90 m; b) 60 m",
        studentAns,
        "Gợi ý: Tỉ lệ 1 : 3 000 cho biết độ dài ngoài thực tế gấp 3 000 lần độ dài trên bản đồ.<br>Bước 1: Lấy độ dài trên bản đồ nhân với 3 000 (cm).<br>Bước 2: Đổi kết quả từ centimét (cm) sang mét (m).",
        "a) Chiều dài thật của thửa đất là: 3 × 3 000 = 9 000 cm = 90 m.<br>b) Chiều rộng thật của thửa đất là: 2 × 3 000 = 6 000 cm = 60 m.<br>Đáp số: a) 90 m; b) 60 m.<br>Chúc mừng em đã tính toán chính xác!"
    );
...
window.check_160_4 = function() {
    ...
    const studentAns = `${v || '?'} ngôi sao`;
    window.showMathFeedback(isCorrect,
        "99 ngôi sao",
        studentAns,
        "Gợi ý: Đây là bài toán tìm hai số khi biết hiệu và tỉ số.<br>Bước 1: Tìm hiệu số phần bằng nhau (5 - 4 = 1 phần).<br>Bước 2: Tính số ngôi sao Việt gấp được (11 : 1 × 4).<br>Bước 3: Tính số ngôi sao Mai gấp được (11 : 1 × 5).<br>Bước 4: Tính tổng số ngôi sao của cả hai bạn.",
        "Hiệu số phần bằng nhau là: 5 - 4 = 1 (phần).<br>Việt gấp được số ngôi sao là: 11 : 1 × 4 = 44 (ngôi sao).<br>Mai gấp được số ngôi sao là: 11 × 5 = 55 (ngôi sao).<br>Cả hai bạn đã gấp được số ngôi sao là: 44 + 55 = 99 (ngôi sao).<br>Đáp số: 99 ngôi sao.<br>Chúc mừng em đã hoàn thành bài tập!"
    );
