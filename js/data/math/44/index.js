            ...
            <div class="p-8 rounded-[2.5rem] bg-gradient-to-br from-blue-700 to-blue-950 shadow-2xl relative overflow-hidden text-white">
                ...
                <div class="flex flex-col md:flex-row items-center gap-8 relative z-10">
                    ...
                    <div class="text-center md:text-left">
                        <h2 class="text-2xl md:text-4xl font-black mb-2 tracking-tight uppercase">Nhân số thập phân với số tự nhiên</h2>
                        <p class="text-blue-100 text-lg md:text-2xl font-medium opacity-90">Học cách tính chiều cao tòa nhà và phương pháp đặt tính nhân số thập phân!</p>
                    </div>
                </div>
            </div>
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <h3 class="text-lg md:text-2xl text-blue-900 font-black uppercase tracking-tighter">Sửa lỗi phép tính</h3>
                                    </div>
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <h3 class="text-lg md:text-2xl text-blue-900 font-black uppercase tracking-tighter">Bài toán thực tế</h3>
                                    </div>
