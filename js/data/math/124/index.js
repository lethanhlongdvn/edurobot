    ...
    "exercises": [
        {
            ...
            "data": [
                ["Đại lượng", "Hình (1)", "Hình (2)", "Hình (3)"],
        ...
        },
        {
            ...
            "image": "assets/images/toan/toan_tap_2/124-b2-cake.webp"
        },
        {
            "id": "124_3",
            "type": "mcq_group",
            ...
            "image": "assets/images/toan/toan_tap_2/124-b3-mairobot.webp"
        }
    ],
    "quizPool": [
        ...
        <div class="theory-section space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000 text-left">
            <div class="bg-gradient-to-br from-blue-600 to-blue-700 p-8 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
                <div class="flex items-center gap-8 relative z-10">
                    <div class="w-20 h-20 bg-white/20 rounded-3xl flex items-center justify-center backdrop-blur-md border border-white/30 text-4xl shadow-lg">🎯</div>
                    <div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            <span class="bg-amber-500 text-white w-14 h-14 rounded-2xl flex items-center justify-center font-black text-3xl shadow-lg italic">?</span>
                            <h4 class="text-4xl font-black text-blue-900 uppercase italic text-left">Khám phá</h4>
                        </div>
                        <p class="text-2xl font-bold text-slate-700 italic border-l-8 border-blue-500 pl-6 bg-blue-50 py-6 rounded-r-3xl leading-relaxed">
                        ...
                        <div class="bg-rose-600 p-8 rounded-3xl text-white text-center shadow-xl">
                            <p class="text-3xl font-black uppercase tracking-widest opacity-80 mb-2">Công thức</p>
                            <p class="text-5xl font-black italic tracking-wide">V = a × a × a</p>
                        </div>
                    </div>
                    <div class="relative group cursor-pointer inline-block mx-auto">
                        <img src="assets/images/toan/toan_tap_2/124-khampha.webp" alt="Khám phá" class="w-full max-w-[550px] h-auto rounded-[40px] shadow-2xl border-8 border-white transform group-hover:rotate-1 transition-all duration-500">
                        <div class="absolute bottom-6 right-6 flex flex-col gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
                            <button onclick="window.openKhamPhaModal124(); event.stopPropagation();" class="w-20 h-20 bg-amber-500 hover:bg-amber-600 text-white rounded-3xl font-black shadow-2xl flex items-center justify-center transform active:scale-90 transition-all text-3xl hover:shadow-amber-200/50 hover:shadow-2xl" title="Mô phỏng 3D">
                                3D
                            </button>
                        </div>
                    </div>
            ...
            <div id="modal-124-khampha" class="fixed inset-0 z-[9999] bg-slate-900/95 hidden flex-col items-center justify-center opacity-0 transition-opacity duration-300 backdrop-blur-md p-4" onclick="window.closeKhamPhaModal124()">
                <div class="bg-blue-50 w-[96%] w-full h-[94vh] max-h-[1000px] rounded-[40px] shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden relative flex flex-col" onclick="event.stopPropagation()">
                    ...
                    <div class="flex-grow flex flex-col p-4 md:p-6 gap-4 relative">
                        <!-- Left: 3D Simulator -->
                        <div class="flex-1 flex flex-col items-center justify-center bg-gradient-to-br from-slate-800 to-purple-950 p-2 md:p-6 rounded-[32px] shadow-2xl border-4 border-blue-200 relative">
    ...
    "practice": `
        <div class="space-y-16 text-left">
            ...
            <div class="glass-card p-10 rounded-[3rem] bg-white border border-teal-50 shadow-2xl">
                 <div class="flex items-start gap-6 mb-12 text-left">
                    <div class="w-16 h-16 bg-teal-600 text-white rounded-2xl flex items-center justify-center text-3xl font-black shadow-lg">1</div>
                    <p class="text-3xl md:text-4xl text-slate-800 leading-relaxed font-black uppercase tracking-tight italic">Hoàn thành bảng</p>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full border-separate border-spacing-2">
                        <thead>
                            <tr class="text-2xl font-black text-teal-900 uppercase">
                                <th class="p-6 bg-teal-50 rounded-3xl shadow-sm text-left">Đại lượng</th>
                                <th class="p-6 bg-white border-2 border-teal-100 rounded-3xl shadow-sm">Hình (1)</th>
                                <th class="p-6 bg-white border-2 border-teal-100 rounded-3xl shadow-sm">Hình (2)</th>
                                <th class="p-6 bg-white border-2 border-teal-100 rounded-3xl shadow-sm">Hình (3)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="text-center font-bold text-2xl">
                            ...
                            <tr class="text-center">
                                <td class="p-6 bg-amber-400 text-white rounded-3xl font-black text-2xl uppercase italic">Thể tích (V)</td>
                                <td class="p-6 bg-white border-4 border-teal-500/20 rounded-3xl">
                                    <input type="number" id="ans-124-1a" class="w-full bg-transparent border-none text-center p-2 text-4xl font-black text-teal-600 outline-none placeholder:text-slate-200" placeholder="?">
                                </td>
                                <td class="p-6 bg-white border-4 border-teal-500/20 rounded-3xl">
                                    <input type="number" step="0.001" id="ans-124-1b" class="w-full bg-transparent border-none text-center p-2 text-4xl font-black text-teal-600 outline-none placeholder:text-slate-200" placeholder="?">
                                </td>
                                <td class="p-6 bg-white border-4 border-teal-500/20 rounded-3xl">
                                    <input type="number" step="0.001" id="ans-124-1c" class="w-full bg-transparent border-none text-center p-2 text-4xl font-black text-teal-600 outline-none placeholder:text-slate-200" placeholder="?">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="flex justify-center mt-12">
                    <button onclick="window.check_124_1()" class="w-24 h-24 bg-teal-600 text-white rounded-3xl font-black text-5xl shadow-xl hover:scale-105 active:scale-95 transition-all">E</button>
                </div>
            </div>
            ...
            <div class="glass-card p-10 rounded-[3rem] bg-emerald-900 border-emerald-700 shadow-2xl relative overflow-hidden text-white">
                <div class="flex items-start gap-6 mb-12 text-left">
                     ...
                     <p class="text-3xl md:text-4xl text-white leading-relaxed font-black uppercase tracking-tight italic">Chiếc bánh bông lan</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
                    <div class="space-y-8">
                        <p class="text-2xl font-bold text-emerald-100 italic leading-snug text-left">
                        ...
                        <div class="flex items-center gap-4 bg-white/10 p-6 rounded-[2.5rem] border border-white/20">
                             <input type="number" id="ans-124-2" class="w-full bg-transparent border-none text-center p-2 text-5xl font-black text-yellow-300 outline-none placeholder:text-white/20" placeholder="?">
                             <span class="text-3xl font-black text-emerald-200 italic shrink-0">cm³</span>
                        </div>
                    </div>
                    <img src="assets/images/toan/toan_tap_2/124-b2-cake.webp" class="rounded-[2.5rem] shadow-2xl border-4 border-white/20">
                </div>
                <div class="flex justify-center text-left">
                     <button onclick="window.check_124_2()" class="w-24 h-24 bg-yellow-400 text-emerald-900 rounded-3xl font-black text-5xl shadow-xl hover:scale-105 active:scale-95 transition-all">E</button>
                </div>
            </div>
            ...
            <div class="glass-card p-10 rounded-[3rem] bg-rose-50 border-rose-100 shadow-xl relative overflow-hidden">
                 <div class="flex items-start gap-6 mb-12 text-left">
                    <div class="w-16 h-16 bg-rose-600 text-white rounded-2xl flex items-center justify-center text-3xl font-black shadow-lg">3</div>
                    <p class="text-3xl md:text-4xl text-rose-900 leading-relaxed font-black uppercase tracking-tight italic">So sánh hình khối</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
                     <img src="assets/images/toan/toan_tap_2/124-b3-mairobot.webp" class="rounded-[2.5rem] border-4 border-white shadow-2xl order-2 md:order-1">
                     <div class="space-y-12 order-1 md:order-2">
                        <div class="space-y-6">
                            <p class="text-2xl font-black text-rose-800 italic uppercase tracking-tighter">a) Mai cần bỏ bao nhiêu hình LP nhỏ để được hình Rô-bốt?</p>
                            <div class="flex flex-wrap gap-3">
                                <button onclick="window.select_124_3a('10')" id="btn-124-3a-10" class="px-8 py-4 bg-white border-2 border-rose-200 rounded-2xl text-2xl font-black text-rose-300 hover:bg-rose-600 hover:text-white transition-all uppercase">10 hình</button>
                                <button onclick="window.select_124_3a('12')" id="btn-124-3a-12" class="px-8 py-4 bg-white border-2 border-rose-200 rounded-2xl text-2xl font-black text-rose-300 hover:bg-rose-600 hover:text-white transition-all uppercase">12 hình</button>
                            </div>
                        </div>
                        <div class="space-y-6">
                            <p class="text-2xl font-black text-rose-800 italic uppercase tracking-tighter">b) Nếu mỗi khối nhỏ cạnh 2cm, thể tích hình Rô-bốt là?</p>
                            <div class="flex flex-wrap gap-3">
                                <button onclick="window.select_124_3b('64')" id="btn-124-3b-64" class="px-8 py-4 bg-white border-2 border-rose-200 rounded-2xl text-2xl font-black text-rose-300 hover:bg-rose-600 hover:text-white transition-all uppercase">64 cm³</button>
                                <button onclick="window.select_124_3b('216')" id="btn-124-3b-216" class="px-8 py-4 bg-white border-2 border-rose-200 rounded-2xl text-2xl font-black text-rose-300 hover:bg-rose-600 hover:text-white transition-all uppercase">216 cm³</button>
                            </div>
                        </div>
                     </div>
                </div>
                <div class="flex justify-center mt-12">
                    <button onclick="window.check_124_3()" class="w-24 h-24 bg-rose-600 text-white rounded-3xl font-black text-5xl shadow-xl hover:scale-105 active:scale-95 transition-all">E</button>
                </div>
            </div>
        </div>
        ...
        window.check_124_1 = function() {
            ...
            window.showMathFeedback(isCorrect, "1000; 15.625; 0.064", \`\${v1}; \${v2}; \${v3}\`, "V = a × a × a.", 
                \`<p class="text-left text-2xl font-bold text-emerald-700">Chính xác! Thể tích của 3 hình lần lượt là: 1000 cm³; 15.625 dm³; 0.064 m³.</p>\`
            );
        ...
        window.check_124_2 = function() {
            ...
            window.showMathFeedback(isCorrect, "648", v, "V_bánh = 12x12x6 = 864. V_cắt = 6x6x6 = 216. V_còn = 864 - 216 = 648.", 
                \`<p class="text-left text-2xl font-bold text-emerald-700">Đúng rồi! Thể tích phần bánh còn lại là 648 cm³.</p>\`
            );
        ...
        window.select_124_3a = function(v) {
            ...
            ['10','12'].forEach(o => {
                ...
                b.className = (o===v) ? "px-8 py-4 bg-rose-600 border-2 border-transparent rounded-2xl text-2xl font-black text-white shadow-xl scale-110 transition-all uppercase" : "px-8 py-4 bg-white border-2 border-rose-200 rounded-2xl text-2xl font-black text-rose-300 hover:bg-rose-600 hover:text-white transition-all uppercase opacity-50";
            });
        };
        ...
        window.check_124_3 = function() {
            ...
            window.showMathFeedback(isAll, "10 hình; 64 cm³", \`\${ans3a}; \${ans3b}\`, "a) 10 hình. b) 8 khối x 8cm³ = 64cm³.", 
                \`<p class="text-left text-2xl font-bold text-emerald-700">Giỏi quá! Mai cần bỏ 10 hình. Thể tích hình Rô-bốt là 64 cm³.</p>\`
            );
