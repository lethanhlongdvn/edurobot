...
(function() {
    ...
    function ensureBlocksData124() {
        if (window.blocksData124) return window.blocksData124;
        ...
        return window.blocksData124;
    }

    function createController(key, ids) {
        if (!window.lesson124CubeControllers) window.lesson124CubeControllers = {};
        if (window.lesson124CubeControllers[key]) return window.lesson124CubeControllers[key];
        ...
        window.lesson124CubeControllers[key] = controller;
        return controller;
    }
    ...
    function setupDrag(controller) {
        ...
        const handleDragStart = (e) => {
            if (wrapper.classList.contains('rotate-anim-124')) return;
    ...
    function fillCube(controller) {
        ...
        const blocksData = ensureBlocksData124();
    ...
    window.initLesson124CubeController = function(mode) {
        const isPre = mode === 'pre';
        const ids = isPre
            ? { scene: 'scene-124-pre', wrapper: 'cube-wrapper-124-pre', layers: 'cube-layers-124-pre', button: 'btn-fill-124-pre' }
            : { scene: 'scene-124', wrapper: 'cube-wrapper-124', layers: 'cube-layers-124', button: 'btn-fill-124' };
    ...
    window.fillKhamPha124 = function() {
        const controller = window.initLesson124CubeController('modal');
        fillCube(controller);
    };
    ...
    window.fillKhamPha124Pre = function() {
        const controller = window.initLesson124CubeController('pre');
        fillCube(controller);
    };
    ...
    window.openKhamPhaModal124 = function() {
        ...
        if (!modal) return;
        window.initLesson124CubeController('modal');
