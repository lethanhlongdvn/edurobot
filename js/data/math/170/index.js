            ...
            <div class="bg-gradient-to-br from-blue-50 to-sky-50 p-6 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border-4 border-blue-200 shadow-xl relative overflow-hidden">
                <div class="relative z-10 space-y-6">
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <h3 class="text-2xl md:text-3xl font-black text-blue-700 uppercase tracking-wide text-center">TÌM HIỂU BÀI: ÔN TẬP BẢNG SỐ LIỆU VÀ BIỂU ĐỒ</h3>
                    </div>

                    <!-- Grid 4 chủ đề chính -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 font-bold">
                        
                        <!-- 1. Phân loại & Đọc dữ liệu -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-blue-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-blue-700 text-xl md:text-2xl">Phân loại & Đọc dữ liệu</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Phân loại theo tiêu chí đơn: <span class="font-black text-blue-800">màu sắc</span> (Đỏ, Vàng, Xanh) hoặc <span class="font-black text-blue-800">hình dạng</span> (Vuông, Tam giác, Thang, Tròn).</p>
                                <p>• Phân loại theo tiêu chí kép: ví dụ <span class="font-black text-blue-800">Hình tròn màu xanh</span>, <span class="font-black text-blue-800">Hình thang màu vàng</span>.</p>
                            </div>
                        </div>

                        <!-- 2. Lập bảng số liệu thống kê -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-emerald-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-emerald-700 text-xl md:text-2xl">Lập bảng số liệu thống kê</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Đổi đơn vị đo phù hợp (1 tấn = 1 000 kg).</p>
                                <p>• Tính khối lượng còn lại: <span class="font-black text-emerald-800">Tổng − (A + B + C + D)</span>.</p>
                                <p>• Sắp xếp các số liệu theo thứ tự từ lớn đến bé hoặc từ bé đến lớn.</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-amber-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-amber-700 text-xl md:text-2xl">Phân tích biểu đồ cột</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Đọc độ cao các cột để xác định giá trị của từng tỉnh/đối tượng.</p>
                                <p>• Xác định giá trị <span class="font-black text-amber-800">lớn nhất</span>, <span class="font-black text-amber-800">nhỏ nhất</span>.</p>
                                <p>• Tính số trung bình cộng: <span class="font-black text-amber-800">Tổng số liệu : Số đối tượng</span>.</p>
                            </div>
                        </div>

                        <!-- 4. Biểu đồ quạt tròn & Tỉ số % -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-rose-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-rose-700 text-xl md:text-2xl">Biểu đồ quạt tròn & Tỉ số %</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Tính tỉ số phần trăm từng thành phần: <span class="font-black text-rose-800">Giá trị thành phần : Tổng × 100%</span>.</p>
                                <p>• Tổng tỉ số phần trăm của tất cả các phần trên biểu đồ quạt tròn luôn bằng <span class="font-black text-rose-700">100%</span>.</p>
                            </div>
                        </div>
            ...
            <div id="ltViewport" style="overflow:hidden; width:100%; position:relative;">
                <div id="ltTrack" class="flex transition-transform duration-500 ease-out" style="width: 100%; display: flex;">
                    ...
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson170_b1" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-blue-500 space-y-6">
                    ...
                    <!-- Slide 2: Bài 2 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson170_b2" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-emerald-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
                    ...
                    <!-- Slide 3: Bài 3 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson170_b3" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-amber-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
                            ...
                            <div id="sol-170-3" class="hidden bg-amber-50 p-4 rounded-2xl border border-amber-200 text-lg font-bold text-amber-900 space-y-1">
                                <p>a) Gia Lai: 105 000, Đắk Lắk: 213 500.</p>
                    ...
                    <!-- Slide 4: Bài 4 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson170_b4" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-rose-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
