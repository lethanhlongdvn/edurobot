export const lesson172 = {
    ...
    practice: `
        <div class="space-y-10 pb-10">
            ...
            <!-- Bài 1: Đọc viết số tự nhiên và giá trị chữ số -->
            <div id="lesson172_b1" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-blue-500 space-y-6">
                ...
                <div class="bg-blue-50 p-5 rounded-2xl border border-blue-200 space-y-4 font-bold text-lg">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3 flex-wrap">
                            ...
                            <input id="172-1-1" style="padding: 0px !important; font-size: 1.25rem !important; line-height: 38px !important;" class="w-36 h-10 text-center border-2 border-blue-300 rounded-xl font-bold outline-none" placeholder="?">
                        </div>
                        <div class="flex items-center gap-3 flex-wrap">
                            <span>Hàng 2: 1 triệu, 3 trăm nghìn, 0 chục nghìn, 6 nghìn, 5 trăm, 2 chục, 4 đơn vị. Viết số:</span>
                            <input id="172-1-2" style="padding: 0px !important; font-size: 1.25rem !important; line-height: 38px !important;" class="w-36 h-10 text-center border-2 border-blue-300 rounded-xl font-bold outline-none" placeholder="?">
                        </div>
                        <div class="flex items-center gap-3 flex-wrap">
                            <span>Hàng 3: 7 trăm nghìn, 2 chục nghìn, 0 nghìn, 4 trăm, 5 chục, 1 đơn vị. Viết số:</span>
                            <input id="172-1-3" style="padding: 0px !important; font-size: 1.25rem !important; line-height: 38px !important;" class="w-36 h-10 text-center border-2 border-blue-300 rounded-xl font-bold outline-none" placeholder="?">
                        </div>
                    </div>
            ...
            <!-- Bài 2: Sắp xếp số từ bé đến lớn -->
            <div id="lesson172_b2" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-emerald-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
            ...
            <!-- Bài 3: Phân số & tô màu -->
            <div id="lesson172_b3" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-amber-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
            ...
            <!-- Bài 4: Số thập phân -->
            <div id="lesson172_b4" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-rose-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
                ...
                <div class="bg-rose-50 p-5 rounded-2xl border border-rose-200 space-y-4 font-bold text-lg">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <input id="172-4-1" style="padding: 0px !important; font-size: 1.25rem !important; line-height: 38px !important;" class="w-28 h-10 text-center border-2 border-rose-300 rounded-xl font-bold outline-none" placeholder="?">
                        </div>
                        <div class="flex items-center gap-2 flex-wrap">
                            <span>Bốn trăm linh năm đơn vị và sáu mươi mốt phần trăm:</span>
                            <input id="172-4-2" style="padding: 0px !important; font-size: 1.25rem !important; line-height: 38px !important;" class="w-28 h-10 text-center border-2 border-rose-300 rounded-xl font-bold outline-none" placeholder="?">
                        </div>
                        <div class="flex items-center gap-2 flex-wrap">
                            <span>Không đơn vị, bảy mươi tư phần nghìn:</span>
                            <input id="172-4-3" style="padding: 0px !important; font-size: 1.25rem !important; line-height: 38px !important;" class="w-28 h-10 text-center border-2 border-rose-300 rounded-xl font-bold outline-none" placeholder="?">
                        </div>
                    </div>
            ...
            <!-- Bài 5: So sánh số thập phân & Chiều cao Rô-bốt -->
            <div id="lesson172_b5" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-teal-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
...
window.check_172_3 = function() {
    ...
    window.showMathFeedback(isCorrect,
        ...
        "",
        "Gợi ý: a) Hình C chia 8 phần, tô màu 5 phần. b) 16/24 chia cả tử và mẫu cho 8 = 2/3.",
...
window.check_172_4 = function() {
    ...
    window.showMathFeedback(isCorrect,
        ...
        "",
        "Gợi ý: Viết các chữ số vào đúng vị trí sau dấu phẩy (phần mười, phần trăm, phần nghìn).",
...
window.check_172_5 = function() {
    ...
    window.showMathFeedback(isCorrect,
        ...
        "",
        "Gợi ý: a) So sánh từ phần nguyên đến các hàng thập phân. b) Đỏ thấp nhất (0,89m), Vàng (0,98m), Xanh cao nhất (1,02m).",
