            ...
            <div class="bg-gradient-to-br from-blue-50 to-sky-50 p-6 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border-4 border-blue-200 shadow-xl relative overflow-hidden">
                <div class="relative z-10 space-y-6">
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <h3 class="text-2xl md:text-3xl font-black text-blue-700 uppercase tracking-wide text-center">TÌM HIỂU BÀI: ÔN TẬP TOÁN CHUYỂN ĐỘNG ĐỀU (TIẾT 2)</h3>
                    </div>

                    <!-- Grid 4 chủ đề nâng cao -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 font-bold">
                        
                        <!-- 1. So sánh vận tốc khác đơn vị -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-blue-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-blue-700 text-xl md:text-2xl">So sánh vận tốc khác đơn vị</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Muốn so sánh hai vận tốc, ta phải <span class="font-black text-blue-800">đưa về cùng một đơn vị</span> (đều là km/h hoặc m/s).</p>
                                <p class="bg-blue-50 p-3 rounded-xl border border-blue-200 text-blue-900">
                                    9 m/s = 9 × 3,6 = <span class="font-black">32,4 km/h</span>.<br>
                                    Vì 32,4 km/h &lt; 36 km/h nên 9 m/s &lt; 36 km/h.
                                </p>
                            </div>
                        </div>

                        <!-- 2. Chuyển động nhiều chặng -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-emerald-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-emerald-700 text-xl md:text-2xl">Chuyển động nhiều chặng</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Tính quãng đường đi chặng 1: <span class="font-black text-emerald-800">s₁ = v₁ × t₁</span>.</p>
                                <p>• Quãng đường còn lại của chặng 2: <span class="font-black text-emerald-800">s₂ = S_{tổng} − s₁</span>.</p>
                            </div>
                        </div>

                        <!-- 3. Thời điểm khởi hành -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-amber-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-amber-700 text-xl md:text-2xl">Tính thời điểm khởi hành</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• <span class="font-black text-amber-800">Thời điểm khởi hành = Thời điểm đến − Thời gian đi</span>.</p>
                                <p class="bg-amber-50 p-3 rounded-xl border border-amber-200 text-amber-900">
                                    12 giờ 15 phút − 2 giờ 30 phút = <span class="font-black">9 giờ 45 phút</span>.
                                </p>
                            </div>
                        </div>

                        <!-- 4. Chuyển động của đoàn tàu qua cầu -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-rose-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-rose-700 text-xl md:text-2xl">Đoàn tàu qua cầu/hầm</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• <span class="font-black text-rose-800">Quãng đường tàu đi = Chiều dài cầu + Chiều dài tàu</span>.</p>
                                <p>• <span class="font-black text-rose-800">Chiều dài tàu = Quãng đường tàu đi − Chiều dài cầu</span>.</p>
                            </div>
                        </div>
            ...
            <div id="ltViewport" style="overflow:hidden; width:100%; position:relative;">
                <div id="ltTrack" class="flex transition-transform duration-500 ease-out" style="width: 100%; display: flex;">
                    ...
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson169_b1" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-blue-500 space-y-6">
                    ...
                    <!-- Slide 2: Bài 2 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson169_b2" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-emerald-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
                    ...
                    <!-- Slide 3: Bài 3 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson169_b3" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-amber-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
                    ...
                    <!-- Slide 4: Bài 4 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson169_b4" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-rose-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
