export const lesson162 = {
    ...
    practice: `
        <div class="space-y-10 pb-10">
            ...
            <!-- Bài 1: Hình chữ nhật và hình vuông -->
            <div id="lesson162_b1" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-blue-500 space-y-6">
                ...
                <img src="assets/images/toan/toan_tap_2/162/162-1-hinh-cn-hv.png" class="max-w-[650px] w-full mx-auto rounded-2xl shadow border-4 border-white" alt="Công thức hình chữ nhật và hình vuông">
            ...
            <!-- Bài 2: Hình tam giác và hình thang -->
            <div id="lesson162_b2" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-emerald-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
                ...
                <img src="assets/images/toan/toan_tap_2/162/162-2-tam-giac-thang.png" class="max-w-[650px] w-full mx-auto rounded-2xl shadow border-4 border-white" alt="Công thức diện tích hình tam giác và hình thang">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Tam giác -->
                    <div class="bg-emerald-50 p-5 rounded-2xl border border-emerald-200 space-y-4">
            ...
            <!-- Bài 3: Hình tròn -->
            <div id="lesson162_b3" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-amber-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
                ...
                <img src="assets/images/toan/toan_tap_2/162/162-3-hinh-tron.png" class="max-w-[600px] w-full mx-auto rounded-2xl shadow border-4 border-white" alt="Công thức hình tròn và đĩa sứ">
                <div class="bg-amber-50 p-5 rounded-2xl border border-amber-200 space-y-4">
                    <p class="font-black text-amber-700 text-lg border-b border-amber-200 pb-2">a) Công thức (r = bán kính)</p>
                    <div class="flex items-center gap-3 flex-wrap text-xl font-bold">
                        <span>C = 3,14 ×</span>
            ...
            <!-- Bài 4: Miếng bìa hình vuông cạnh 20 cm -->
            <div id="lesson162_b4" class="ltTrang bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-rose-500 space-y-6">
                <div class="flex items-center gap-4 mb-2">
                ...
                <div class="bg-rose-50 p-5 rounded-2xl border border-rose-200 space-y-4">
                    ...
                    <img src="assets/images/toan/toan_tap_2/162/162-4-mia-bia-vuong.png" class="max-w-[350px] w-full mx-auto rounded-2xl shadow border-4 border-white" alt="Miếng bìa vuông cắt hình tròn">
                    <div class="space-y-3">
