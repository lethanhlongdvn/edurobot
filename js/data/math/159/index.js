        ...
        <div class="space-y-12 pb-10">
            ...
            <div id="lesson159_b2" class="bg-white p-10 rounded-[3rem] shadow-2xl border-t-[12px] border-emerald-500">
                <div class="flex items-center gap-6 mb-10">
                    ...
                    <h3 class="text-2xl md:text-3xl font-black text-emerald-700 uppercase tracking-wide">Bài 2. Tính nhẩm</h3>
                </div>
            ...
            <div id="lesson159_b3" class="bg-white p-10 rounded-[3rem] shadow-2xl border-t-[12px] border-sky-500">
                <div class="flex items-center gap-6 mb-10">
                    ...
                    <h3 class="text-2xl md:text-3xl font-black text-sky-700 uppercase tracking-wide">Bài 3. Tính giá trị của biểu thức</h3>
                </div>
            ...
            <div id="lesson159_b5" class="bg-white p-10 rounded-[3rem] shadow-2xl border-t-[12px] border-teal-500">
                <div class="flex items-center gap-6 mb-10">
                    ...
                    <h3 class="text-2xl md:text-3xl font-black text-teal-700 uppercase tracking-wide">Bài 5. Chọn câu trả lời đúng</h3>
                </div>
...
window.check_159_1 = function () {
    ...
    window.showMathFeedback(
        isCorrect,
        "a) 14 138 : 45 = 314 (dư 8). Thử lại: 314 × 45 + 8 = 14 138. b) 8 924 : 23 = 388. Thử lại: 388 × 23 = 8 924",
        "",
        "Gợi ý: Hãy kiểm tra lại thương và số dư. Nhớ thử lại bằng công thức: Số chia × Thương + Số dư = Số bị chia."
    );
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 1. Tính rồi thử lại", Math.round(correct / total * 100), "btn-check-159-1", 0, total, correct);
    }
};
...
window.check_159_2 = function () {
    ...
    window.showMathFeedback(
        isCorrect,
        "276; 276; 43,2; 43,2; 7082; 7082; 3,605; 3,605; 4523; 4523; 0,697; 0,697",
        "",
        "Gợi ý: Nhân với 10/100/1000 → dời dấu phẩy sang phải. Chia cho 10/100/1000 → dời dấu phẩy sang trái."
    );
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 2. Tính nhẩm", Math.round(correct / total * 100), "btn-check-159-2", 0, total, correct);
    }
};
...
window.check_159_3 = function () {
    ...
    window.showMathFeedback(
        isCorrect,
        "a) 61,4 × (15 : 0,25) – 2024 = 61,4 × 60 – 2024 = 3684 – 2024 = 1660. b) 15/14 × 28/9 + 7/4 : 3/5 = 10/3 + 35/12 = 75/12 = 25/4",
        "",
        "Gợi ý: a) Tính trong ngoặc trước: 15 : 0,25 = 60. b) Nhân/chia phân số trước, rồi cộng."
    );
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 3. Tính giá trị biểu thức", Math.round(correct / total * 100), "btn-check-159-3", 0, total, correct);
    }
};
...
window.check_159_4 = function () {
    ...
    const total = 2;
    if (v1 === '55') score++;
    if (v2 === '2' || v2 === '2.0') score++;
    const isCorrect = score === total;

    window.showMathFeedback(
        isCorrect,
        "Mỗi bộ cần: 2,06 + 1,54 = 3,6 m. Số bộ: 200 : 3,6 = 55 (dư 2 m vải). Đáp số: 55 bộ, thừa 2 m vải.",
        "",
        "Gợi ý: Tính vải cho 1 bộ = 2,06 + 1,54 = 3,6 m. Rồi lấy 200 : 3,6 = ? (lấy phần nguyên)."
    );
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 4. Giải bài toán", Math.round(score / total * 100), "btn-check-159-4", 0, total, score);
    }
};
...
window.check_159_5 = function () {
    ...
    window.showMathFeedback(
        isCorrect,
        "4 : 0,5 × 2,5 = 4 × 2 × 2,5 (vì chia cho 0,5 tương đương nhân với 2). Đáp án B đúng.",
        "",
        "Gợi ý: Chia cho 0,5 tương đương với nhân với 2. Hãy thử tính kết quả từng biểu thức."
    );
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 5. Chọn câu đúng", isCorrect ? 100 : 0, "btn-check-159-5", 0, 1, isCorrect ? 1 : 0);
    }
};
