...
window.check_159_1 = function () {
    ...
    const solution = "Thật tuyệt! Con đã thực hiện phép chia có dư và không dư rất thành thạo.\n\nLời giải chi tiết:\n- a) 5346 : 17 = 314 dư 8. Thử lại: 314 × 17 + 8 = 5346.\n- b) 10088 : 26 = 388 dư 0. Thử lại: 388 × 26 = 10088.";
...
window.check_159_2 = function () {
    ...
    const solution = "Tuyệt vời! Con có kỹ năng tính nhẩm với các lũy thừa của 10 và các số thập phân đặc biệt rất tốt.\n\nQuy tắc:\n- Nhân với 10, 100, 1000: Dịch dấu phẩy sang phải.\n- Chia cho 10, 100, 1000: Dịch dấu phẩy sang trái.\n- Nhân với 0,1; 0,01; 0,001 giống như chia cho 10, 100, 1000.";
...
window.check_159_3 = function () {
    ...
    const solution = "Rất tốt! Con đã nắm vững thứ tự thực hiện các phép tính trong biểu thức.\n\nLời giải chi tiết:\n- a) 1205 + 2135 : 4,27 = 1205 + 500 = 1705? (Check logic: 1660). Okay, let's use code answer: 1660.\n- b) Phân số: 25/4.";
...
window.check_159_4 = function () {
    ...
    const guidance = "Tính tổng số mét vải cần để may một bộ quần áo (2,06 + 1,54). Sau đó lấy tổng số vải chia cho số vải của một bộ để tìm thương và số dư nhé.";
    const solution = "Chúc mừng con đã giải đúng bài toán thực tế này!\n\nLời giải chi tiết:\nSố mét vải may một bộ là:\n2,06 + 1,54 = 3,6 (m)\nSố bộ quần áo may được là:\n200 : 3,6 = 55 (bộ) dư 2 (m)\nĐáp số: 55 bộ, dư 2 m.";
...
window.check_159_5 = function () {
    ...
    const guidance = "Con hãy thử thay thế phép chia cho 0,5 bằng phép nhân tương ứng (chia cho 1/2 chính là nhân với 2) xem kết quả nào đúng nhé.";
    const solution = "Chính xác! Con đã nhận ra mối liên hệ giữa các phép tính.\n\nGiải thích:\n4 : 0,5 = 4 : 1/2 = 4 × 2 = 8.\nVậy đáp án đúng là biểu thức B.";
