...
export const vnTemplatePresentation = [
    ...
    <div class="h-full flex flex-col justify-center items-center w-full px-20 bg-gradient-to-br from-emerald-50 to-teal-100 text-center relative overflow-hidden">
        ...
        <div class="relative z-10 animate-fade-in-up">
            <span class="px-8 py-3 bg-emerald-600 text-white rounded-full text-lg md:text-2xl font-black uppercase tracking-[0.4em] mb-8 inline-block shadow-xl">Tiếng Việt 5</span>
    ...
    <div class="h-full flex flex-col justify-center items-center w-full px-12 bg-white relative">
        <div class="absolute top-10 left-12 flex items-center gap-4">
             <div class="w-16 h-16 bg-orange-500 text-white rounded-2xl flex items-center justify-center text-xl md:text-3xl font-black shadow-lg">🚀</div>
             <span class="text-2xl md:text-4xl font-black text-orange-600 uppercase tracking-widest">Khởi động</span>
        </div>
        ...
        <div class="w-full max-w-7xl">
            ...
            <div class="grid grid-cols-2 gap-8 w-full">
                <button onclick="window.checkVnPreQuiz(1, 'A', 'A')" id="btn-vn-pre-1-A" class="kickoff-btn p-10 bg-gray-50 border-4 border-gray-100 rounded-[32px] font-black text-3xl md:text-5xl text-gray-400 hover:border-orange-400 hover:text-orange-600 transition-all shadow-md active:scale-95">
                    A. [Đáp án A]
                </button>
                <button onclick="window.checkVnPreQuiz(1, 'B', 'A')" id="btn-vn-pre-1-B" class="kickoff-btn p-10 bg-gray-50 border-4 border-gray-100 rounded-[32px] font-black text-3xl md:text-5xl text-gray-400 hover:border-orange-400 hover:text-orange-600 transition-all shadow-md active:scale-95">
                    B. [Đáp án B]
                </button>
                <button onclick="window.checkVnPreQuiz(1, 'C', 'A')" id="btn-vn-pre-1-C" class="kickoff-btn p-10 bg-gray-50 border-4 border-gray-100 rounded-[32px] font-black text-3xl md:text-5xl text-gray-400 hover:border-orange-400 hover:text-orange-600 transition-all shadow-md active:scale-95">
                    C. [Đáp án C]
                </button>
                <button onclick="window.checkVnPreQuiz(1, 'D', 'A')" id="btn-vn-pre-1-D" class="kickoff-btn p-10 bg-gray-50 border-4 border-gray-100 rounded-[32px] font-black text-3xl md:text-5xl text-gray-400 hover:border-orange-400 hover:text-orange-600 transition-all shadow-md active:scale-95">
                    D. [Đáp án D]
                </button>
            </div>
        </div>
    ...
    <div class="h-full flex flex-col justify-center items-center w-full px-20 bg-emerald-600 text-white text-center">
        ...
        <p class="text-2xl md:text-4xl font-bold mt-6 opacity-80 italic">Cùng đọc và tìm hiểu bài đọc nào!</p>
    </div>
    `,
    ...
    <div class="h-full flex flex-col justify-center items-center w-full px-12 bg-white">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full max-w-[90rem]">
            <div class="space-y-10">
                <h4 class="text-3xl md:text-5xl font-black text-emerald-900">[Tên bài đọc]</h4>
            ...
            <div class="flex justify-center">
                <div class="w-full aspect-[3/4] bg-gradient-to-br from-emerald-50 to-teal-50 rounded-[48px] border-8 border-white shadow-2xl flex items-center justify-center relative">
                    <span class="text-xl md:text-3xl text-gray-400 font-black tracking-widest uppercase">Hình minh họa bài đọc</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="h-full flex flex-col justify-center items-center w-full px-12 bg-white">
        <div class="w-full max-w-7xl">
            <div class="flex items-center gap-6 mb-12">
                <div class="w-20 h-20 bg-amber-500 text-white rounded-[24px] flex items-center justify-center text-2xl md:text-4xl font-black shadow-lg">❓</div>
    ...
    <div class="h-full flex flex-col justify-center items-center w-full px-20">
        <div class="bg-emerald-600 p-16 rounded-[64px] shadow-2xl w-full max-w-7xl text-white relative">
            ...
            <h4 class="text-2xl md:text-4xl font-black uppercase tracking-[0.3em] mb-12 opacity-90">Ghi nhớ</h4>
