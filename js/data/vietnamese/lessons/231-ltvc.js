...
<div class="space-y-8 animate-in fade-in duration-700">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-blue-50/50 rounded-2xl p-4 pr-1 border border-blue-100 mb-3 relative flex items-center justify-between overflow-hidden">
                                        ...
                                        <div class="w-24 md:w-32 flex-shrink-0 flex justify-end">
                                            <img src="assets/images/dechoat_new.png" alt="Dế Choắt" class="w-full h-auto drop-shadow-xl rounded-xl transform translate-x-2 rotate-2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-blue-50/30 rounded-2xl p-4 border border-blue-100">
                                        ...
                                        <div class="mt-2 flex items-center gap-3">
                                            <button onclick="checkEx1bAI()" class="px-5 py-2 bg-blue-600 text-white text-sm font-bold rounded-xl shadow-md hover:bg-blue-700 transition-all active:scale-95 flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                            ...
                                            <div id="fb-231-ex1b" class="hidden text-sm flex-1 bg-white p-2 rounded-lg border border-blue-100 italic"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="bg-amber-50/50 rounded-2xl p-4 border border-amber-100 flex flex-col md:flex-row gap-4 items-center">
                                        ...
                                        <div class="w-16 md:w-20 flex-shrink-0 flex justify-end">
                                            <img src="assets/images/hoa_giay.jpg" alt="Hoa giấy" class="w-full h-auto rounded-xl shadow-md rotate-1">
                                        </div>
                                    </div>
                        ...
                        <section class="w-full">
                            <div class="glass-card rounded-[32px] p-4 md:p-6 shadow-xl border-t-4 border-green-500 bg-green-50/20">
                                <div class="flex items-center space-x-3 mb-4">
                                    ...
                                    <h2 class="text-lg md:text-2xl font-black text-gray-800 uppercase tracking-tight">II. Luyện tập</h2>
                                </div>
                        ...
                        <section class="w-full pb-8">
                            <div class="glass-card rounded-[32px] p-4 md:p-6 shadow-xl border-t-4 border-rose-500">
                                <div class="flex items-center space-x-3 mb-4">
                                    <h2 class="text-lg md:text-2xl font-black text-gray-800 uppercase tracking-tight">III. Vận dụng</h2>
                                </div>
