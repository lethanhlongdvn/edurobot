export const lesson_231_hoi_thoi_com_thi_o_dong_van = {
    ...
    "audio": "assets/audio/tiengviet/hoithoicomthi.wav",
    "content": `
                                    ...
                                    <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl relative overflow-hidden">
                                        ...
                                        <div class="relative z-10">
                                            ...
                                            <div class="float-none md:float-right w-full md:w-[35%] md:ml-8 mb-6 md:mb-2 text-center md:text-right">
                                                <img src="assets/images/hoithoicomthi.png" alt="Minh họa" class="inline-block w-auto max-h-[400px] rounded-3xl object-contain shadow-lg border-4 border-white/50 transform hover:scale-[1.02] transition-transform duration-500">
                                            </div>
                                            ...
                                            <div class="serif-font text-gray-800 text-xl md:text-2xl leading-relaxed text-justify">
                                                ...
                                                <p class="text-right font-black text-blue-600 uppercase tracking-widest text-base mt-8 clear-both pt-4 border-t border-gray-100/50">(Theo Minh Nhương)</p>
                                            </div>
                                        </div>
                                    </div>
                                </section>
