                                                ...
                                                <div class="overflow-x-auto my-6 rounded-xl border border-gray-200 shadow-sm"> 
                                                    <table class="w-full text-sm text-left text-gray-500"> 
                                                        <thead class="text-xs text-gray-700 uppercase bg-blue-50/50">
                                                            <tr>
                                                                <th class="px-6 py-3 font-black text-blue-600">Triều đại</th>
                                                                <th class="px-6 py-3 font-black text-center text-blue-600">Số khoa thi</th>
                                                                <th class="px-6 py-3 font-black text-center text-blue-600">Số tiến sĩ</th>
                                                                <th class="px-6 py-3 font-black text-center text-blue-600">Số trạng nguyên</th>
                                                            </tr>
                                                        </thead> 
                                                        <tbody class="divide-y divide-gray-100"> 
                                                            ...
                                                            <tr class="bg-blue-100/50 font-black text-blue-600"><td class="px-6 py-3">Tổng cộng</td><td class="px-6 py-3 text-center">185</td><td class="px-6 py-3 text-center">2896</td><td class="px-6 py-3 text-center">47</td></tr> 
                                                        </tbody> 
                                                    </table> 
                                                </div> 
                                                <p>
