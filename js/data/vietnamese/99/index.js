...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto text-emerald-950">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-emerald-100 shadow-xl space-y-8">
        ...
        <article class="bg-amber-50 bg-opacity-20 p-6 md:p-10 rounded-[36px] border border-amber-100/50 shadow-inner max-w-4xl mx-auto leading-relaxed text-gray-800 space-y-6">
            <h4 class="text-xl md:text-3xl font-black text-center text-emerald-900 tracking-wide mb-6 uppercase">Tranh làng Hồ</h4>
...
window.submitVn99Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 99',
            '🎨',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🎉</span><p class="text-lg md:text-2xl font-bold text-emerald-800">Chúc mừng em đã hoàn thành bài học Tranh làng Hồ!</p><p class="text-lg text-gray-700 mt-3">Hãy luôn gìn giữ, trân trọng nét đẹp văn hóa và di sản tranh Đông Hồ độc đáo của dân tộc ta nhé!</p></div>'
        );
    } else {
