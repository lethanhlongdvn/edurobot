...
<div class="space-y-12 max-w-4xl mx-auto py-6">
    ...
    <section class="bg-white p-6 md:p-8 rounded-[32px] border border-slate-100 shadow-xl space-y-6">
        ...
        <div class="flex justify-center pt-2">
            <button onclick="check205Q1()" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-md text-lg uppercase">Kiểm tra bài 1</button>
        </div>
    ...
    <section class="bg-white p-6 md:p-8 rounded-[32px] border border-slate-100 shadow-xl space-y-6">
        ...
        <div class="flex justify-center pt-2">
            <button onclick="check205Q2()" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-md text-lg uppercase">Kiểm tra phân loại</button>
        </div>
    ...
    <section class="bg-white p-6 md:p-8 rounded-[32px] border border-slate-100 shadow-xl space-y-6">
        ...
        <div class="p-6 bg-amber-50/30 border border-amber-100 rounded-3xl space-y-4">
            ...
            <div class="flex justify-center">
                <button onclick="check205EssayAI()" class="px-8 py-4 bg-sky-600 hover:bg-sky-700 text-white font-black rounded-2xl shadow-xl transition-all active:scale-[0.95] flex items-center justify-center gap-3 text-lg uppercase tracking-wider cursor-pointer">
                    <span>🤖</span>
                    <span>Nộp câu cho Thầy E AI kiểm tra vế câu</span>
                </button>
            </div>
