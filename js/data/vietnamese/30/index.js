...
window.submitVn30Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 30',
            '✍️',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">📝</span><p class="text-lg md:text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài học LTVC: Từ đồng nghĩa!</p><p class="text-lg text-gray-800 mt-3">Hãy áp dụng linh hoạt kiến thức về từ đồng nghĩa để viết những đoạn văn sinh động, giàu hình ảnh hơn nhé.</p></div>'
        );
    }
};
