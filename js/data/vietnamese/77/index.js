...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="space-y-4">
            <textarea id="ans-vn77-kd" rows="3" placeholder="Ví dụ: Cuốn sách em yêu thích nhất là 'Không gia đình' của Héc-to Ma-lô. Cuốn sách kể về cuộc phiêu lưu đầy nghị lực của cậu bé Rê-mi..." class="w-full p-4 border-2 border-blue-100 rounded-2xl outline-none focus:border-blue-500 font-bold bg-blue-50/10 text-xl md:text-2xl"></textarea>
            <div class="flex justify-end items-center gap-4"><button onclick="kiemTraKhoiDong77();" class="w-12 h-12 bg-orange-500 hover:bg-orange-600 text-white rounded-full flex items-center justify-center font-black text-xl shadow-md transition-all active:scale-95 shrink-0">E</button></div>
...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <section class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="space-y-6 max-w-4xl mx-auto">
            <div class="bg-gray-50 p-6 rounded-3xl border border-gray-100 space-y-4">
                ...
                <div class="flex justify-end items-center gap-4"><button onclick="kiemTraDanY77();" class="w-12 h-12 bg-orange-500 hover:bg-orange-600 text-white rounded-full flex items-center justify-center font-black text-xl shadow-md transition-all active:scale-95 shrink-0">E</button></div>
    ...
    <div class="pt-6 flex justify-center">
        <button onclick="nopBai77Global()" class="px-12 py-5 bg-gradient-to-r from-blue-600 to-blue-500 hover:scale-105 text-white font-black text-xl rounded-full shadow-xl transition-all active:scale-95 flex items-center gap-3">
...
window.nopBai77Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 78',
            '🗣️',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🗣️</span><p class="text-2xl md:text-3xl font-bold text-blue-600">Chúc mừng em đã hoàn thành bài học hôm nay!</p><p class="text-lg text-gray-800 mt-3">Hãy luôn tự tin chia sẻ những cuốn sách hay tới mọi người xung quanh nhé. Đọc sách và lan tỏa tri thức là một nét văn hóa vô cùng tốt đẹp.</p></div>'
        );
    }
};
