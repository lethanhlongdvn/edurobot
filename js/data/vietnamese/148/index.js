export const lesson148 = {
    ...
    "content": `<div class="space-y-8 animate-in fade-in duration-700">
                            ...
                            <div class="glass-card rounded-[40px] p-8 md:p-10 shadow-2xl relative overflow-hidden">
                                ...
                                <div class="relative z-10">
                                        ...
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="glass-card rounded-xl p-2 shadow-sm bg-white">
                                                    <img src="assets/images/tiengviet_5_2/148/148_1.png" alt="Cuộc sống miền biển" class="w-full h-auto rounded-lg object-cover">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
                                        ...
                                        <div class="serif-font text-gray-800 leading-relaxed pl-4 border-l-2 border-gray-100 space-y-8 reading-content text-xl md:text-4xl">
                                        ...
                                        <div class="space-y-8">
                                            ...
                                            <div class="glass-card p-3 rounded-[24px] shadow-md rotate-1 hover:rotate-0 transition-transform duration-500">
                                                <img src="assets/images/tiengviet_5_2/148/148_2.png" alt="Minh họa" class="w-full h-auto rounded-xl object-cover shadow-sm">
                                            </div>
                                            ...
                                            <div class="serif-font text-gray-800 leading-relaxed pl-4 border-l-2 border-gray-100 space-y-8 reading-content text-xl md:text-4xl">
                                                ...
                                                <p class="text-right font-black text-blue-600 uppercase tracking-widest text-base mt-2">Huy Cận</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4 max-w-4xl mx-auto">
                                    ...
                                    <div class="accordion-item bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all overflow-hidden">
                                        <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                            <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">1. Ở khổ thơ thứ nhất, đoàn thuyền đánh cá ra khơi trong khung cảnh thiên nhiên như thế nào? Cách miêu tả có gì đặc biệt?</span>
                                        </button>
                                        <div class="accordion-content">
                                            <div class="px-6 pb-6 pt-2 text-gray-700 bg-blue-50/20 text-lg md:text-3xl">
                                    ...
                                    <div class="accordion-item bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all overflow-hidden">
                                        <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                            <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">2. Tìm trong bài thơ những chi tiết thể hiện tình cảm, cảm xúc của những người đánh cá trên biển:</span>
                                        </button>
                                        <div class="accordion-content">
                                            <div class="px-6 pb-6 pt-2 text-gray-700 bg-blue-50/20 text-lg md:text-3xl">
                                    ...
                                    <div class="accordion-item bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all overflow-hidden">
                                        <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                            <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">3. Những hình ảnh ở khổ thơ cuối có ý nghĩa gì?</span>
                                        </button>
                                        <div class="accordion-content">
                                            <div class="px-6 pb-6 pt-2 text-gray-700 bg-blue-50/20 text-lg md:text-3xl">
                                    ...
                                    <div class="accordion-item bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all overflow-hidden">
                                        <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                            <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">4. Bài thơ giúp em cảm nhận được vẻ đẹp nào của cuộc sống?</span>
                                        </button>
                                        <div class="accordion-content">
                                            <div class="px-6 pb-6 pt-2 text-gray-700 bg-blue-50/20 text-lg md:text-3xl">
                        ...
                        <section>
                            <div class="bg-gradient-to-br from-blue-900 via-blue-900 to-blue-800 rounded-[32px] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
