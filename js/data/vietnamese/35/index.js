        ...
        <div class="bg-sky-50/20 p-6 rounded-[2.5rem] border border-sky-100 shadow-sm space-y-4 font-bold text-sky-800 text-base md:text-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <div class="p-4 bg-white rounded-2xl border border-sky-100 text-center space-y-2">
                    ...
                    <div class="flex justify-center gap-1.5 text-lg md:text-2xl" id="stars-container-35">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-sky-100 shadow-xl space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 font-bold text-sky-800">
            ...
            <div class="p-6 bg-blue-50 rounded-3xl border border-blue-100 flex flex-col justify-between space-y-4">
                <div>
                    <span class="text-lg md:text-2xl">🐒</span>
                    <h4 class="font-black text-blue-600 text-lg mt-1">Voọc mũi hếch</h4>
                    <p class="text-xs font-semibold text-gray-800 mt-0.5">Loài khỉ đặc hữu của Việt Nam</p>
                    <p class="text-sm text-blue-600 mt-2 font-medium leading-relaxed">Có bộ lông khoang màu đen trắng, mũi hếch ngược đặc trưng. Hiện chỉ còn phân bố rải rác ở một số khu rừng núi phía Bắc.</p>
                </div>
                <button onclick="copSdVn35('Voọc mũi hếch: Đặc hữu Việt Nam, lông đen trắng, sống ở vùng núi đá phía Bắc.')" class="w-full py-2 bg-blue-600 hover:bg-blue-600 text-blue-600 rounded-xl text-sm transition-all active:scale-95">Ghi chép nhanh</button>
            </div>
