            ...
            <div class="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div class="w-full lg:w-1/2 bg-sky-50/10 p-6 md:p-8 rounded-3xl border border-sky-100/50">
                    <div class="serif-font text-gray-800 leading-relaxed space-y-6 text-center lg:text-left select-none text-xl md:text-4xl" id="vn15-poem-container">
                        ...
                        <p class="text-right font-bold text-gray-800 mt-4 text-2xl md:text-3xl">(Tô Hà)</p>
                    </div>
                </div>
        ...
        <div class="p-6 md:p-8 bg-amber-50/30 rounded-[32px] space-y-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-amber-100 shadow-inner space-y-4">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <button onclick="checkWritingVn15()" class="px-8 py-3 bg-amber-500 text-white font-black text-lg rounded-2xl shadow-md hover:bg-amber-500 active:scale-95 transition-all flex items-center gap-2">
                    ...
                    <button onclick="resetWritingVn15()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all text-base">LÀM LẠI</button>
                </div>
