            ...
            <div class="bg-white p-6 rounded-3xl border border-blue-100 shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-2xl">
                    ...
                    <div class="p-5 bg-blue-50/50 rounded-2xl border border-blue-100 flex flex-col gap-3">
                        <p class="font-medium text-gray-800">a. Mỗi lần Ja Ka vỗ trống, các bạn lại cùng múa hát <strong class="text-blue-600 uppercase font-black">tưng bừng</strong>.</p>
                    ...
                    <!-- Từ 2 -->
                    <div class="p-5 bg-blue-50/50 rounded-2xl border border-blue-100 flex flex-col gap-3">
                        <p class="font-medium text-gray-800">b. Bọn mình còn đâu chỗ mà <strong class="text-blue-600 uppercase font-black">vui chơi</strong>!</p>
                        <div class="flex gap-3">
                    ...
                    <!-- Từ 3 -->
                    <div class="p-5 bg-blue-50/50 rounded-2xl border border-blue-100 flex flex-col gap-3">
                        <p class="font-medium text-gray-800">c. Biết ý tưởng đó, nhiều cô bác trong làng đã <strong class="text-blue-600 uppercase font-black">hưởng ứng</strong>.</p>
                        <div class="flex gap-3">
                    ...
                    <!-- Từ 4 -->
                    <div class="p-5 bg-blue-50/50 rounded-2xl border border-blue-100 flex flex-col gap-3">
                        <p class="font-medium text-gray-800">d. Nhóm bạn vui mừng nhảy múa, ca hát trong tiếng trống <strong class="text-blue-600 uppercase font-black">rộn ràng</strong>.</p>
                        <div class="flex gap-3">
