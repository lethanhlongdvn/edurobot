...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto text-blue-600">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="bg-blue-50/30 p-6 rounded-[2rem] border border-blue-100 shadow-inner select-none text-justify">
                    ...
                    <p class="text-right font-black text-blue-600 mt-3">(Thanh Thanh)</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-center">
                <div class="relative group cursor-pointer overflow-hidden rounded-[2rem] border-2 border-blue-200 shadow-md p-2 bg-white max-w-[280px]" 
                    ...
                    <div class="absolute inset-0 bg-blue-900/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-[1.5rem]">
                        <span class="px-4 py-2 bg-white/90 text-blue-600 font-black rounded-full shadow text-sm">🔍 PHÓNG TO</span>
                    </div>
                </div>
            ...
            <div class="max-w-5xl mx-auto space-y-4">
                ...
                <div class="bg-blue-50/40 p-5 rounded-2xl border-2 border-blue-100 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col justify-center">
                        <span class="font-black text-blue-600 text-xl">1. Phần Mở đầu:</span>
                    ...
                    <div class="flex flex-col justify-center">
                        <span class="font-black text-blue-600 text-xl">Ý chính của Mở đầu:</span>
                ...
                <div class="bg-blue-50/40 p-5 rounded-2xl border-2 border-blue-100 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col justify-center">
                        <span class="font-black text-blue-600 text-xl">2. Phần Triển khai:</span>
                    ...
                    <div class="flex flex-col justify-center">
                        <span class="font-black text-blue-600 text-xl">Ý chính của Triển khai:</span>
                ...
                <div class="bg-blue-50/40 p-5 rounded-2xl border-2 border-blue-100 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col justify-center">
                        <span class="font-black text-blue-600 text-xl">3. Phần Kết thúc:</span>
                        <span class="text-base text-gray-700 font-bold mt-1">Giới hạn từ đâu đến đâu?</span>
                    ...
                    <div class="flex flex-col justify-center">
                        <span class="font-black text-blue-600 text-xl">Ý chính của Kết thúc:</span>
        ...
        <div class="space-y-4 border-t border-blue-100 pt-6">
            ...
            <div class="max-w-4xl mx-auto bg-blue-50/20 p-6 rounded-[2rem] border-2 border-blue-200/50 space-y-4">
                <div class="flex flex-col md:flex-row items-center gap-4 justify-center">
                    ...
                    <span class="text-blue-500 font-black text-lg md:text-2xl">➔</span>
                    <div class="px-5 py-3 bg-white rounded-xl border border-blue-300 font-bold text-center text-lg shadow-sm">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        ...
        <!-- 💡 Ghi nhớ -->
        <div class="p-6 bg-gradient-to-r from-blue-700 to-blue-600 text-white rounded-[2rem] shadow-lg relative overflow-hidden">
            <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-white/10 rounded-full blur-2xl"></div>
            <h4 class="text-lg md:text-2xl font-black mb-3 flex items-center gap-2">
                <span>💡</span> GHI NHỚ
            </h4>
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        <div class="flex flex-col md:flex-row items-center justify-between border-b border-blue-100 pb-4">
            ...
            <div class="flex items-center gap-3 mt-4 md:mt-0 bg-blue-50 p-2 rounded-2xl">
                <span class="font-bold text-base text-blue-600">Chế độ xem:</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Bài thơ Nói với em -->
            <div class="space-y-4">
                <h4 class="text-lg md:text-2xl font-black text-blue-600 text-center">Nói với em</h4>
            ...
            <div class="space-y-6 flex flex-col justify-between">
                <div class="bg-blue-50/30 p-6 rounded-[2rem] border border-blue-100 space-y-4">
                    <span class="font-black text-blue-600 text-xl">🎙️ Tập nói & Ghi âm chia sẻ cảm nghĩ:</span>
                    ...
                    <div class="flex flex-col items-center justify-center gap-4 py-4">
                        <button id="record-btn-vn94" onclick="toggleRecordVn94()" class="w-16 h-16 rounded-full bg-red-500 text-white hover:bg-red-600 active:scale-95 transition-all shadow-md flex items-center justify-center text-lg md:text-2xl">
                            🎤
                        </button>
                ...
                <div class="bg-blue-50/30 p-6 rounded-[2rem] border border-blue-100 space-y-4">
                    <span class="font-black text-blue-600 text-xl">📝 Câu chuyện nghệ thuật:</span>
