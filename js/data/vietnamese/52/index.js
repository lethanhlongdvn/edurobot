...
window.submitVn52Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 52',
            '🎨',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🎨</span><p class="text-lg md:text-2xl font-bold text-amber-600">Chúc mừng em đã hoàn thành viết bài văn tả phong cảnh!</p><p class="text-lg text-gray-800 mt-3">Việc viết văn tả cảnh giúp em rèn luyện khả năng quan sát thiên nhiên và làm tâm hồn thêm phong phú. Hãy luôn tự hào về vẻ đẹp của đất nước mình nhé.</p></div>'
        );
    }
};
