...
<div class="flex justify-end mb-4">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-4">
        ...
        <p class="text-xl text-blue-600 font-bold leading-relaxed">
            ...
            <div class="flex gap-4 justify-center">
                <div class="relative group overflow-hidden rounded-2xl border-2 border-blue-200 p-1 bg-white max-w-[200px]"
                    ...
                    <div class="absolute inset-0 bg-blue-900/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-xl">
                        <span class="px-3 py-1.5 bg-white/95 text-blue-600 font-black rounded-full shadow text-xs">🔍 XEM TRANH</span>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        <div class="flex items-center justify-between border-b border-blue-100 pb-4">
            ...
            <button onclick="window.showMathFeedback(true, '&lt;div class=&amp;quot;p-6 text-center space-y-4 bg-white rounded-[32px] border-4 border-blue-600 shadow-2xl&amp;quot;&gt;&lt;span class=&amp;quot;text-6xl animate-bounce inline-block&amp;quot;&gt;📻&lt;/span&gt;&lt;p class=&amp;quot;text-2xl font-black text-blue-600&amp;quot;&gt;Đang phát giọng đọc mẫu bài học...&lt;/p&gt;&lt;div class=&amp;quot;flex justify-center gap-1.5 h-6 mt-4&amp;quot;&gt;&lt;span class=&amp;quot;w-1.5 bg-blue-600 rounded-full animate-bounce h-4&amp;quot;&gt;&lt;/span&gt;&lt;span class=&amp;quot;w-1.5 bg-blue-600 rounded-full animate-bounce h-6\u0026quot; style=\u0026quot;animation-delay: 0.15s\u0026quot;&gt;&lt;/span&gt;&lt;span class=&amp;quot;w-1.5 bg-blue-600 rounded-full animate-bounce h-3\u0026quot; style=\u0026quot;animation-delay: 0.3s\u0026quot;&gt;&lt;/span&gt;&lt;/div&gt;&lt;/div&gt;')" class="p-3 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-full transition-all shadow-sm flex items-center justify-center text-xl" title="Nghe đọc mẫu">
                🔊 Nghe đọc mẫu
            </button>
        </div>
        ...
        <div class="space-y-8">
            <div class="w-full bg-blue-50/20 p-6 md:p-10 rounded-[40px] border border-blue-100 shadow-inner relative overflow-hidden">
                ...
                <div id="bai-doc-tri-tuong-tuong" class="serif-font text-blue-950 leading-relaxed space-y-6 text-justify font-normal text-xl md:text-4xl">
                    ...
                    <p class="text-right font-black text-blue-600 mt-2 text-lg font-sans font-bold">(Theo Dun Dơ-rim, Bảo Khanh dịch)</p>
                </div>
            </div>
    ...
    <div class="bg-gradient-to-r from-blue-700 to-blue-600 p-8 rounded-[36px] text-white shadow-2xl border-4 border-blue-100 relative overflow-hidden animate-in slide-in-from-bottom duration-500">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                <h4 class="text-lg md:text-2xl font-black text-blue-600 flex items-start gap-2">
                ...
                <div class="relative group cursor-pointer overflow-hidden rounded-xl border border-blue-200 max-w-[100px]"
                    ...
                    <div class="absolute inset-0 bg-blue-900/10 opacity-0 group-hover:opacity-100 flex items-center justify-center rounded-lg">
                        <span class="bg-white/95 px-1 py-0.5 rounded text-[10px] font-black text-blue-600">ZOOM</span>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-4 border-t border-blue-100 pt-6">
            ...
            <div class="max-w-4xl mx-auto space-y-4 bg-blue-50/10 p-6 rounded-[2rem] border-2 border-blue-100 text-lg md:text-3xl">
                ...
                <div class="flex flex-wrap items-center gap-2 text-lg font-bold leading-loose text-gray-800">
                    ...
                    <select id="vn95-blank-a" class="p-1.5 border border-blue-300 rounded-lg outline-none bg-white font-bold text-blue-600 text-base">
                ...
                <div class="flex flex-wrap items-center gap-2 text-lg font-bold leading-loose text-gray-800 border-t border-blue-100/50 pt-3">
                    ...
                    <select id="vn95-blank-b" class="p-1.5 border border-blue-300 rounded-lg outline-none bg-white font-bold text-blue-600 text-base">
                        <option value="">-- Chọn từ --</option>
                        <option value="mơ tưởng">mơ tưởng</option>
                        <option value="liên tưởng">liên tưởng</option>
                        <option value="ý tưởng">ý tưởng</option>
                ...
                <div class="flex flex-wrap items-center gap-2 text-lg font-bold leading-loose text-gray-800 border-t border-blue-100/50 pt-3">
                    ...
                    <select id="vn95-blank-c" class="p-1.5 border border-blue-300 rounded-lg outline-none bg-white font-bold text-blue-600 text-base">
                        <option value="">-- Chọn từ --</option>
                        <option value="mơ tưởng">mơ tưởng</option>
                        <option value="liên tưởng">liên tưởng</option>
                        <option value="ý tưởng">ý tưởng</option>
                ...
                <div class="flex flex-wrap items-center gap-2 text-lg font-bold leading-loose text-gray-800 border-t border-blue-100/50 pt-3">
                    ...
                    <select id="vn95-blank-d1" class="p-1.5 border border-blue-300 rounded-lg outline-none bg-white font-bold text-blue-600 text-base">
                        <option value="">-- Chọn từ --</option>
                        <option value="mơ tưởng">mơ tưởng</option>
                        <option value="liên tưởng">liên tưởng</option>
                        <option value="ý tưởng">ý tưởng</option>
                    ...
                    <select id="vn95-blank-d2" class="p-1.5 border border-blue-300 rounded-lg outline-none bg-white font-bold text-blue-600 text-base">
                        <option value="">-- Chọn từ --</option>
                        <option value="mơ tưởng">mơ tưởng</option>
                        <option value="liên tưởng">liên tưởng</option>
                        <option value="ý tưởng">ý tưởng</option>
