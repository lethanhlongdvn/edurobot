export const lesson130 = {
    ...
    <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl mb-8">
                                    <div class="bg-paper rounded-[32px] p-8 md:p-12 shadow-inner border border-white/50 relative overflow-hidden">
                                        ...
                                        <div class="serif-font text-gray-800 leading-relaxed relative text-left reading-content text-lg md:text-4xl">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <details class="group bg-white/50 rounded-[24px] border border-white shadow-sm transition-all hover:shadow-md overflow-hidden">
                                            ...
                                            <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-white/50 pt-4 bg-blue-50/30 text-lg md:text-3xl">
                                                <div class="flex items-center space-x-2 mb-2">
                                                    ...
                                                    <span class="text-[11px] font-black uppercase tracking-widest text-green-600">Trả lời</span>
                                                </div>
                                                <p class="font-medium text-lg md:text-3xl">Bài thơ như lời ru qua các từ ngữ: "Em cu Tai ngủ trên lưng mẹ ơi", "ngủ ngoan a-kay ơi", "ngủ ngoan a-kay hỡi".</p>
                                            </div>
                                        </details>
                                        ...
                                        <details class="group bg-white/50 rounded-[24px] border border-white shadow-sm transition-all hover:shadow-md overflow-hidden">
                                            ...
                                            <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-white/50 pt-4 bg-blue-50/30 text-lg md:text-3xl">
                                                ...
                                                <p class="font-medium text-lg md:text-3xl">Mẹ giã gạo, tỉa bắp trên nương rẫy để nuôi bộ đội, góp phần vào cuộc kháng chiến giành độc lập.</p>
                                            </div>
                                        </details>
                                        ...
                                        <details class="group bg-white/50 rounded-[24px] border border-white shadow-sm transition-all hover:shadow-md overflow-hidden">
                                            ...
                                            <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-white/50 pt-4 bg-blue-50/30 text-lg md:text-3xl">
                                                ...
                                                <p class="font-medium text-lg md:text-3xl">Mẹ mong con ngủ ngoan, lớn lên khỏe mạnh ("vung chày lún sân") để tiếp bước cha ông lao động và chiến đấu.</p>
                                            </div>
                                        </details>
                                        ...
                                        <details class="group bg-white/50 rounded-[24px] border border-white shadow-sm transition-all hover:shadow-md overflow-hidden">
                                            ...
                                            <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-white/50 pt-4 bg-blue-50/30 text-lg md:text-3xl">
                                                ...
                                                <p class="font-medium text-lg md:text-3xl">"Mặt trời của bắp" là thiên nhiên, còn "Mặt trời của mẹ" chính là đứa con - nguồn hạnh phúc và hy vọng lớn nhất của mẹ.</p>
                                            </div>
                                        </details>
                                    </div>
                                </div>
