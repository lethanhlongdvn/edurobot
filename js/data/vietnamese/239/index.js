    ...
    <div class="space-y-8 md:space-y-12 animate-in fade-in duration-700 max-w-4xl mx-auto pb-12">
        ...
        <section class="bg-white p-6 md:p-10 rounded-[40px] shadow-xl border border-blue-100 space-y-6">
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 space-y-4 hidden" id="story-detail-239">
                ...
                <div class="flex justify-end pt-2">
                    <button onclick="window.submitStoryReview239()" class="px-6 py-2.5 bg-blue-600 text-white font-black rounded-xl hover:bg-blue-700 transition-all">Lưu tóm tắt truyện</button>
                </div>
        ...
        <section class="bg-white p-6 md:p-10 rounded-[40px] shadow-xl border border-emerald-100 space-y-6" id="ex-239-fill">
            ...
            <div class="flex items-center justify-between pt-4">
                <button onclick="window.resetFill239()" class="px-6 py-2.5 bg-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-300">LÀM LẠI</button>
                <button id="btn-check-fill" onclick="window.checkFill239()" class="w-12 h-12 md:w-16 md:h-16 bg-blue-600 text-white rounded-2xl font-black text-2xl md:text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
            </div>
        ...
        <section class="bg-white p-6 md:p-10 rounded-[40px] shadow-xl border border-sky-100 space-y-6">
            ...
            <div class="flex justify-end pt-2">
                <button onclick="window.submitPhrase239()" class="px-6 py-2.5 bg-blue-600 text-white font-black rounded-xl hover:bg-blue-700 transition-all">Nộp câu phân biệt</button>
            </div>
        ...
        <section class="bg-white p-6 md:p-10 rounded-[40px] shadow-xl border border-orange-100 space-y-6" id="ex-239-link">
            ...
            <div class="flex items-center justify-between pt-4">
                <button onclick="window.resetLink239()" class="px-6 py-2.5 bg-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-300">LÀM LẠI</button>
                <button id="btn-check-link" onclick="window.checkLink239()" class="w-12 h-12 md:w-16 md:h-16 bg-blue-600 text-white rounded-2xl font-black text-2xl md:text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
            </div>
        ...
        <section class="bg-white p-6 md:p-10 rounded-[40px] shadow-xl border border-blue-100 space-y-6">
            ...
            <div class="bg-blue-50/30 p-6 rounded-3xl space-y-4">
                ...
                <div class="flex justify-end pt-2">
                    <button onclick="window.submitWeatherScene239()" class="px-6 py-2.5 bg-blue-600 text-white font-black rounded-xl hover:bg-blue-700 transition-all">Nộp bài viết tả cảnh</button>
                </div>
