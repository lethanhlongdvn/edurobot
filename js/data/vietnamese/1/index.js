        ...
        <div class="p-6 md:p-8 bg-amber-50/30 rounded-[32px]">
            ...
            <div class="bg-white p-6 rounded-3xl border border-amber-100 shadow-inner">
                <h4 class="text-lg md:text-3xl font-bold text-gray-900 mb-4 flex items-start gap-3">
                    ...
                    <div>
                        <span>Tưởng tượng em cũng tham gia vào trò chơi bịt tai nghe gió. Em hãy viết 2-3 câu kể lại những thanh âm kì diệu hoặc lời khuyên của gió mà em nghe được.</span>
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <button onclick="checkWritingVn1()" class="px-8 py-3 bg-amber-500 text-white font-black text-lg rounded-2xl shadow-md hover:bg-amber-500 active:scale-95 transition-all flex items-center gap-2">
                        <div class="w-6 h-6 bg-white rounded-lg flex items-center justify-center text-amber-900 font-black text-xs shadow-sm">E</div> 
                        <span>CHẤM BÀI</span>
                    </button>
                    <button onclick="resetWritingVn1()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all">LÀM LẠI</button>
