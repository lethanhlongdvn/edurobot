        ...
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    <span class="text-lg md:text-2xl font-black bg-emerald-500 text-white px-3 py-1 rounded-lg">Đạt 100%</span>
...
window.submitVn87Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 87',
            '🎉',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">✍️</span><p class="text-lg md:text-2xl font-bold text-sky-850">Chúc mừng em đã hoàn thành xuất sắc bài viết cảm xúc về câu chuyện!</p><p class="text-lg text-gray-700 mt-3">Một bài viết hay không chỉ bộc lộ cảm xúc chân thành mà còn cần sự chỉnh chu trong từng câu chữ sau khi đọc soát.</p></div>'
        );
    } else {
