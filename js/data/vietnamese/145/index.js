...
<div class="glass-card rounded-[40px] p-6 md:p-10 shadow-xl border border-blue-100/50 bg-white/60 max-w-5xl mx-auto space-y-12 animate-in fade-in duration-700">
    ...
    <section class="space-y-6">
        <div class="flex items-center space-x-4 mb-6 justify-center">
            <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200">
            ...
            <h2 class="text-3xl md:text-4xl font-black text-gray-800 tracking-tight uppercase">Tìm hiểu bài đọc</h2>
        </div>
