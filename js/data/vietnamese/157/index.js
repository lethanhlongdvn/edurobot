            ...
            <div class="bg-white rounded-[40px] p-6 md:p-10 shadow-xl border border-blue-100 relative overflow-hidden">
                ...
                <div class="bg-gray-50 p-6 rounded-3xl border border-gray-200/60 space-y-6">
                    ...
                    <div class="flex justify-end pt-2">
                        <button id="btn-check-157-1a" onclick="window.checkEx1a_157()" class="w-12 h-12 md:w-16 md:h-16 bg-blue-600 text-white rounded-2xl font-black text-2xl md:text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
                    </div>
        ...
        <section class="w-full">
            <div class="bg-white rounded-[40px] p-6 md:p-10 shadow-xl border border-blue-100">
                ...
                <div class="flex items-center justify-between mt-8">
                    <button onclick="window.resetEx1b_157()" class="px-6 py-2.5 bg-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-300">LÀM LẠI</button>
                    <button id="btn-check-157-1b" onclick="window.checkEx1b_157()" class="w-12 h-12 md:w-16 md:h-16 bg-blue-600 text-white rounded-2xl font-black text-2xl md:text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
                </div>
    ...
    <div class="space-y-8 md:space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto pb-12">
        ...
        <section class="w-full">
            <div class="bg-white rounded-[40px] p-6 md:p-8 shadow-xl border border-blue-100 space-y-8">
                ...
                <!-- Nút kiểm tra E -->
                <div class="flex justify-end pt-2">
                    <button id="btn-check-157-cd" onclick="window.checkExCd_157()" class="w-12 h-12 md:w-16 md:h-16 bg-blue-600 text-white rounded-2xl font-black text-2xl md:text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
                </div>
