...
Bài làm: ${i}`;window.submitMathLesson(h,r,null,0),console.log(`[LessonCore] Đã gửi yêu cầu lưu bài tự luận ${c} với điểm: ${r}`)}};window.AIInteraction.gradeWithModal("👨‍🏫 Thầy E Nhận Xét & Chấm Điểm",s+o,a)}},renderLessonPage(e,t,n=[]){const i=!!(typeof t.content=="function"||typeof t.content=="string"&&t.content.trim()||Array.isArray(t.tabs)&&t.tabs.some(l=>l.id==="study")),s=!!(typeof t.practice=="function"||typeof t.practice=="string"&&t.practice.trim()||typeof t.practice=="object"&&t.practice!==null&&Object.keys(t.practice).length>0||Array.isArray(t.tabs)&&t.tabs.some(l=>l.id==="practice")),o=!!(t.quizPool||t.metadata&&t.metadata.quizPool||t.quizFile||t.period==="156"||Array.isArray(t.tabs)&&t.tabs.some(l=>l.id==="quiz")),a=!!t.pptLink;let r=!1;try{const l=localStorage.getItem("userRole");r=l==="teacher"||l==="admin"}catch{}return`
            <div class="max-w-full mx-auto pb-10 px-1 pt-1">
                <div class="text-center mb-6 animate-slide-down flex flex-col md:flex-row items-center justify-center gap-4 relative">
                    ...
                    <div class="hidden md:flex absolute right-0 -top-6 flex-col items-end gap-2 z-[100]">
                        ${r&&Array.isArray(t.presentation)&&t.presentation.length>0?`
...
`+JSON.stringify(window.problems120C)),i.classList.remove("hidden"),i.innerHTML=`
        ...
        `},currentQuiz:[],currentIndex:0,score:0,correctCount:0,streak:0,isProcessing:!1,audioCtx:null,_leaderboardUnsub:null,async initQuiz(e=null,t=0){const n=e||window.currentLessonData;console.log(`[Quiz] Khởi tạo Quiz - Tiết: ${n==null?void 0:n.period} - Lần: ${t}`);const i=document.getElementById("quiz-pool-info"),s=document.getElementById("quiz-content");if(!((n==null?void 0:n.quizPool)&&n.quizPool.length>0)&&t<10){console.warn(`[Quiz] Dữ liệu chưa sẵn sàng cho bài ${n==null?void 0:n.period}, đang thử lại...`),setTimeout(()=>b.initQuiz(n,t+1),500);return}let a=(n==null?void 0:n.quizPool)||[];if(a.length===0){console.error("[Quiz] Không tìm thấy quizPool sau 10 lần thử."),s&&(s.innerHTML='<div class="text-center py-20 text-gray-400 font-bold italic">Không tìm thấy dữ liệu thử thách cho bài học này.</div>');return}console.log(`[Quiz] Tìm thấy ${a.length} câu hỏi. Đang chuẩn bị bộ câu hỏi ngẫu nhiên...`);const r=(n==null?void 0:n.quizCount)||10;let l=[...a].sort(()=>.5-Math.random()).slice(0,r);if(b.currentQuiz=l,b.currentIndex=0,b.score=0,b.correctCount=0,b.streak=0,b.startTime=Date.now(),i){const d=Math.round(100/l.length);l.length===a.length?i.innerText=`Thử thách bao gồm tất cả ${l.length} câu hỏi ôn tập (${d}%/câu).`:i.innerText=`Hệ thống chọn ngẫu nhiên ${l.length} câu (${d}%/câu) từ kho dữ liệu bài học.`}b.renderCurrentQuestion(),window.db&&b.loadLeaderboard(n)},renderCurrentQuestion(){if(!b.currentQuiz||b.currentQuiz.length===0){console.error("[Quiz] renderCurrentQuestion: currentQuiz rỗng");return}if(b.currentIndex>=b.currentQuiz.length){b.finishQuiz();return}const e=b.currentQuiz[b.currentIndex],t=document.getElementById("quiz-content");if(!t)return;const n=e.options.map((a,r)=>r);for(let a=n.length-1;a>0;a--){const r=Math.floor(Math.random()*(a+1));[n[a],n[r]]=[n[r],n[a]]}const i=n.map(a=>e.options[a]),s=n.indexOf(e.answer);b._currentShuffledAnswer=s;const o=document.getElementById("quiz-progress-fill");o&&(o.style.width=`${(b.currentIndex+1)/b.currentQuiz.length*100}%`),console.log(`[Quiz] Câu ${b.currentIndex+1} - Đáp án gốc: ${e.answer} → Sau trộn: ${s}`),t.innerHTML=`
            <div class="animate-slide-in-right">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <h3 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white leading-tight flex-1">
                        <span class="text-orange-500 font-black mr-2">Câu ${b.currentIndex+1}:</span> ${e.question}
                    </h3>
                    ...
                    <div class="flex gap-3 shrink-0">
                        <div class="flex flex-col items-center px-4 py-2 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border-2 border-blue-100 dark:border-blue-800/30 min-w-[80px]">
                            ...
                            <span class="text-2xl font-black text-blue-600 dark:text-blue-400 leading-none">${b.score}</span>
                        </div>
                    </div>
                </div>
        ...
        `},selectAnswer(e){if(b.isProcessing)return;b.isProcessing=!0;const t=b._currentShuffledAnswer,n=e===t;n?(b.correctCount++,b.score=Math.round(b.correctCount/b.currentQuiz.length*100),b.playSFX("correct"),b.showLottieFeedback(!0),typeof confetti=="function"&&confetti({particleCount:50,spread:60,origin:{y:.8}})):(b.playSFX("wrong"),b.showLottieFeedback(!1));const i=document.querySelectorAll(".quiz-opt-btn"),s=document.querySelectorAll(".opt-indicator");i.forEach((o,a)=>{o.onclick=null,a===e&&(n?(o.classList.add("border-emerald-500","bg-emerald-50","dark:bg-emerald-900/20"),s[a].classList.add("bg-emerald-500","border-emerald-500","text-white"),s[a].innerHTML="✓"):(o.classList.add("border-rose-500","bg-rose-50","dark:bg-rose-900/20"),s[a].classList.add("bg-rose-500","border-rose-500","text-white"),s[a].innerHTML="✕")),o.classList.add("opacity-50"),a===e&&o.classList.remove("opacity-50")}),setTimeout(()=>{b.currentIndex++,b.isProcessing=!1,b.renderCurrentQuestion()},n?1500:2500)},finishQuiz(){const e=Math.round((Date.now()-b.startTime)/1e3),t=document.getElementById("quiz-content");t&&(t.innerHTML=`
            <div class="text-center animate-bounce-in py-10">
                ...
                <p class="text-2xl text-gray-500 dark:text-gray-400 mb-8">
                    Bạn đúng <span class="text-orange-600 font-black">${b.correctCount}/${b.currentQuiz.length}</span> câu. 
                    Điểm số: <span class="text-blue-600 font-black">${b.score}</span>
                </p>
        ...
        `,typeof confetti=="function"&&confetti({particleCount:150,spread:70}))},submitProgress(e){if(window.submitMathLesson){const t=`Trắc nghiệm tổng: Đúng ${b.correctCount}/${b.currentQuiz.length} câu. (Củng cố: ${b.score})`;window.submitMathLesson(t,b.score,"btn-submit-final",e,b.currentQuiz.length,b.correctCount)}},loadLeaderboard(e){var o;if(!window.db||!e)return;const t=document.getElementById("quiz-leaderboard-list");if(!t)return;const n=String(e.period||e.id),i=((o=window.router)==null?void 0:o.currentSubject)||"vietnamese",s=i==="math"?"Toán học":i==="history"?"Lịch sử - Địa lý":"Tiếng Việt";b._leaderboardUnsub&&b._leaderboardUnsub(),t.innerHTML='<div class="text-center py-8 text-slate-500"><i class="fas fa-spinner fa-spin text-2xl mb-2 opacity-30"></i><p class="text-[10px] font-black uppercase tracking-widest">Đang nạp bảng vàng...</p></div>',b._leaderboardUnsub=window.db.collection("diem_tieng_viet_lop5").where("period","==",n).where("subject","==",s).onSnapshot(a=>{var m;if(a.empty){t.innerHTML=`
                        ...
                        <table class="w-full text-left border-collapse min-w-[650px]">
                            <thead>
                                <tr class="text-[9px] font-black text-slate-500 uppercase tracking-tighter border-b border-white/5">
                                    ...
                                    ${Array.from({length:d}).map((p,x)=>`
                                        <th class="px-2 py-3 text-center">
                                            <div class="flex flex-col items-center">
                                                <span class="text-base mb-1">${c[x]||"📝"}</span>
                                                <span class="${h[x]||"text-slate-500"}">Bài ${x+1}</span>
                                            </div>
                                        </th>
                                    `).join("")}
                                    <th class="px-2 py-3 text-center">
                            ...
                            <tbody class="divide-y divide-white/5">
                                ${l.map((p,x)=>{const f=Array.from({length:d}).map((P,X)=>p[`scoreEx${X+1}`]),k=p.scoreQuiz||p.score||0,S=e.exercises?e.exercises.length:3;let B=0;for(let P=1;P<=S;P++)B+=p[`scoreEx${P}`]||0;const q=Math.round(B/S),K=Math.round((q+k)/2);return`
                                        <tr class="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors group">
                                            <td class="px-3 py-3.5">
                                                <div class="w-6 h-6 flex items-center justify-center rounded-lg ${x===0?"bg-amber-400 text-amber-900 shadow-lg shadow-amber-400/20":x===1?"bg-slate-300 text-slate-800":x===2?"bg-orange-400 text-orange-900":"bg-slate-800 text-slate-500"} text-[10px] font-black">${x+1}</div>
                                            </td>
                                            <td class="px-3 py-3.5">
                                                <div class="text-xs font-black text-slate-800 dark:text-slate-100 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">${p.studentName||"Học sinh"}</div>
                                                <div class="text-[10px] font-bold text-slate-500 dark:text-slate-400">${p.studentSchool||"Trường"} - ${p.studentClass||"Lớp"}</div>
                                            </td>
                                            ${f.map(P=>`
                ...
                `})},playSFX(e){try{b.audioCtx||(b.audioCtx=new(window.AudioContext||window.webkitAudioContext)),b.audioCtx.state==="suspended"&&b.audioCtx.resume();const t=b.audioCtx.createOscillator(),n=b.audioCtx.createGain();t.connect(n),n.connect(b.audioCtx.destination);const i=b.audioCtx.currentTime;e==="correct"?(t.frequency.setValueAtTime(600,i),t.frequency.exponentialRampToValueAtTime(1200,i+.1),n.gain.exponentialRampToValueAtTime(.01,i+.3),t.start(i),t.stop(i+.3)):(t.frequency.setValueAtTime(300,i),t.frequency.exponentialRampToValueAtTime(100,i+.3),n.gain.exponentialRampToValueAtTime(.01,i+.4),t.start(i),t.stop(i+.4))}catch{}},showLottieFeedback(e){const t=document.getElementById("quiz-gamification-layer");t&&(t.classList.add("bg-black/10","backdrop-blur-[2px]"),t.innerHTML=`
                        ...
                        <tr class="hover:bg-blue-50/30 dark:hover:bg-blue-900/5 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-bold text-sm text-indigo-950 dark:text-slate-200">${i.name}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-center">
...
`);this.data=[];for(let i of n){if(i=i.trim(),!i||i.startsWith("//")||i.startsWith("#")||i.toUpperCase().startsWith("ID"))continue;const s=i.split("|").map(u=>u.trim());if(s.length<5)continue;const o=s[0],a=s[1],r=isNaN(a)?a:parseInt(a)||0,l=parseInt(s[2])||1,d=s[3],c=s[4],h=s[5]?s[5].split(",").map(u=>u.trim()).filter(u=>u):[];this.data.push({id:o,period:r,level:l,q:d,a:c,customDistractors:h})}},generateDistractors(e,t){let n=new Set,i=e.match(/^([\d.,]+)\s*(.*)$/),s=e.match(/(\d+)\s*([a-zA-Záàãảạăắằẵẳặâấầẫẩậéèẽẻẹêếềễểệíìĩỉịóòõỏọôốồỗổộơớờỡởợúùũủụưứừữửựýỳỹỷỵđ]+)\s*(\d+)?\s*([a-zA-Záàãảạăắằẵẳặâấầẫẩậéèẽẻẹêếềễểệíìĩỉịóòõỏọôốồỗổộơớờỡởợúùũủụưứừữửựýỳỹỷỵđ]+)?/i);if(i&&!s){const a=i[1].replace(",","."),r=parseFloat(a),l=i[2]||"";if(!isNaN(r)){const d=[r*10,r/10,r+1,r-1,r+10,r-10,r+.5,r-.5,parseFloat(a.split("").reverse().join(""))].filter(c=>c>0&&c!==r).map(c=>{let h=Number.isInteger(c)?c.toString():c.toFixed(1).replace(".0","");return l?`${h} ${l}`:h});d.sort(()=>Math.random()-.5);for(let c of d)if(c!==e&&n.add(c),n.size>=3)break}}if(n.size<3&&s&&s[3]){let a=parseInt(s[1]),r=s[2],l=parseInt(s[3]),d=s[4]||"";const c=`${a+1} ${r} ${l} ${d}`.trim(),h=`${a} ${r} ${l+10} ${d}`.trim(),u=`${a-1>0?a-1:a+2} ${r} ${l} ${d}`.trim(),g=`${l} ${r} ${a} ${d}`.trim();[c,h,u,g].forEach(m=>{m!==e&&n.add(m)})}let o=[...t].filter(a=>a!==e&&a.length>0);o.sort(()=>Math.random()-.5);for(let a of o){if(n.size>=3)break;n.add(a)}for(;n.size<3;){let a=Math.floor(Math.random()*100)+1;!n.has(a.toString())&&a.toString()!==e&&n.add(a.toString())}return Array.from(n).slice(0,3)},async getQuestions(e={}){await this.init();let t=this.data;if(e.periods){const s=Array.isArray(e.periods)?e.periods:[e.periods];t=t.filter(o=>s.includes(o.period))}let n=[];if(e.countsPerLevel)for(let[s,o]of Object.entries(e.countsPerLevel)){let a=t.filter(r=>r.level==parseInt(s));a.sort(()=>Math.random()-.5),n=n.concat(a.slice(0,o))}else{let s=e.totalCount||10;n=[...t].sort(()=>Math.random()-.5).slice(0,s)}const i=Array.from(new Set(t.map(s=>s.a)));return n.map(s=>{let o=[...s.customDistractors];if(o.length<3){let l=this.generateDistractors(s.a,i);for(let d of l){if(o.length>=3)break;o.includes(d)||o.push(d)}}let a=[s.a,...o].slice(0,4);a.sort(()=>Math.random()-.5);let r=a.indexOf(s.a);return{id:s.id,period:s.period,level:s.level,question:s.q,options:a,answer:r}})},async getQuizPool(e){await this.init();const t=String(e);if(this._quizPoolCache[t])return this._quizPoolCache[t];const n=this.data.filter(s=>String(s.period)===t);if(n.length===0)return[];const i=this._toQuizPool(n);return this._quizPoolCache[t]=i,i},_toQuizPool(e){const t=Array.from(new Set(e.map(n=>n.a)));return e.map(n=>{let i=[...n.customDistractors];if(i.length<3){const a=this.generateDistractors(n.a,t);for(const r of a){if(i.length>=3)break;!i.includes(r)&&r!==n.a&&i.push(r)}}let s=[n.a,...i.filter(a=>a!==n.a)].slice(0,4);s.sort(()=>Math.random()-.5);const o=s.indexOf(n.a);return{question:n.q,options:s,answer:o}})},async hasPeriod(e){return await this.init(),this.data.some(t=>String(t.period)===String(e))},async getPeriodStats(){await this.init();const e={};return this.data.forEach(t=>{const n=String(t.period);e[n]=(e[n]||0)+1}),e}};window.QuestionBankManager=te;const Ee={renderModal(){let e=document.getElementById("qb-admin-modal");e||(e=document.createElement("div"),e.id="qb-admin-modal",e.className="fixed inset-0 z-[2147483647] bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 transition-opacity duration-300 pointer-events-auto",document.body.appendChild(e)),e.classList.remove("hidden"),e.innerHTML=`
        ...
        `;a.innerHTML=d,window.scrollTo(0,0)},handleSearch(e){const t=this.currentSubject,n=j.find(r=>r.id===t),i=this.isAdmin(),o=(_[t]||[]).filter(r=>i||!r.hidden).filter(r=>{const l=e.toLowerCase().trim();return r.title.toLowerCase().includes(l)||r.period.toLowerCase().includes(l)||`tuần ${r.week}`.toLowerCase().includes(l)}),a=document.getElementById("dashboard-lesson-list");a&&(a.innerHTML=y.renderLessonList(o,n.color))},async renderLesson(e,t,n=!1){if(!n){window.location.hash=`/lesson/${e}/${t}`;return}const i=j.find(c=>c.id===e);let s=(_[e]||[]).find(c=>String(c.id)===String(t)||String(c.period)===String(t));(!i||!s)&&(console.warn(`[Router] Lesson not found in manifest: ${e}/${t}. Trying fuzzy match...`),s=(_[e]||[]).find(c=>String(c.id).toLowerCase()===String(t).toLowerCase()||String(c.period).toLowerCase()===String(t).toLowerCase()));const o=this.isAdmin(),a=`${e}_${(s==null?void 0:s.period)||t}`,r=((s==null?void 0:s.hidden)||this.contentLocks.lessons[a])&&!o;if(!i||!s||r){if(console.error(`[Router] Error: Access denied or lesson not found ${e}/${t}`),r)alert("Bài học này hiện đang bị khóa. Vui lòng quay lại sau!"),this.goHome();else{const c=document.getElementById("app-content");c&&(c.innerHTML=`
            ...
            `);try{(!window.__lessonCache||typeof window.__lessonCache.has!="function")&&(window.__lessonCache=new Map);const c=window.__lessonCache,h=`${e}_${t}`;if(c.has(h))Object.assign(s,c.get(h));else if(!s.content){const u=String(s.period).padStart(3,"0"),g=[];if(s.modulePath){const x=s.modulePath.replace("./","").replace(/\.js$/i,"");g.push(`/js/data/${e}/${x}.js`)}g.push(`/js/data/${e}/${u}/index.js`),g.push(`/js/data/${e}/${u}.js`);let m=null;for(const x of g)try{const f=x+`?v=${Date.now()}`;if(console.log(`[Router] Loading: ${f}`),m=await import(f),m)break}catch{}let p=null;if(m){const x=`lesson${e==="math"?s.period:u}`;p=s.exportName&&m[s.exportName]||m.lessonData||m[x]||m.default||Object.values(m)[0]}if(!p){console.warn(`[Router] Physical module missing for ${e}/${t}, fetching placeholders...`);try{const x=await fe(Object.assign({"../data/math/placeholders.js":()=>Z(()=>import("./placeholders-Bm95jhxt.js"),[]),"../data/science/placeholders.js":()=>Z(()=>import("./placeholders-Czdk4T-k.js"),[]),"../data/vietnamese/placeholders.js":()=>Z(()=>import("./placeholders-Du637W2M.js"),[])}),`../data/${e}/placeholders.js`,4),f=x.placeholderLessons||x[`${e.toUpperCase()}_PLACEHOLDERS`];f&&(p=Array.isArray(f)?f.find(k=>String(k.period)===String(t)):f[t])}catch(x){console.error(`[Router] Failed to load placeholders for ${e}:`,x)}}if(p)Object.assign(s,p),c.set(h,p);else throw new Error(`Không thể tìm thấy nội dung bài học: ${e}/${t}`)}this.runPrefetch(e,s)}catch(c){console.error(`[Router] Critical loading error for ${e}/${t}:`,c),l&&(l.innerHTML=`
