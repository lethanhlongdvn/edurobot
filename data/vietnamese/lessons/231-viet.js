...
<div class="space-y-8 animate-in fade-in duration-700">
                        ...
                        <section class="w-full">
                            <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl relative overflow-hidden ring-1 ring-blue-100">
                                ...
                                <div class='bg-blue-50/80 p-4 rounded-[24px] border border-blue-200 text-blue-600 text-base font-bold flex items-center gap-3 mb-8 animate-in slide-in-from-left-4'>
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1a">
                                        <p class="font-bold text-blue-600 mb-3 flex items-center gap-2">
                                    ...
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1b">
                                        <p class="font-bold text-blue-600 mb-4">b. Chọn nội dung tương ứng với mỗi phần của đoạn văn.</p>
                                        ...
                                        <div class="mt-4 flex gap-2">
                                            <button onclick="check231Viet_1b()" class="px-5 py-2 bg-blue-600 text-white font-bold rounded-xl shadow-md border-0 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                            ...
                                            <div id="fb-v231-1b" class="hidden text-sm flex-1 bg-white p-2 rounded-lg border border-blue-100 italic font-bold"></div>
                                        </div>
                                    </div>

                                    <!-- Câu c (4 dòng) -->
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1c">
                                        <p class="font-bold text-blue-600 mb-2 flex items-center gap-2">
                        ...
                        <section class="w-full pb-8">
                            <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl border-t-8 border-blue-500 bg-blue-50/20">
                                <div class="flex items-center space-x-4 mb-8">
                                    <div class="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg text-white">
                                ...
                                <div class="space-y-8">
                                    <div class="bg-white rounded-3xl p-6 shadow-sm border border-blue-100" id="block-v231-lt1">
                                        <div class="flex items-start gap-4 mb-4">
                                            <div class="bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0 mt-1 shadow-md">1</div>
                                            <p class="text-xl font-bold text-gray-800 leading-relaxed flex items-center gap-3">
                                                ...
                                                <button onclick="toggleSpeech('ai-v231-lt1')" class="p-2 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-sm shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                            </p>
                                        </div>
                                        <textarea id="ai-v231-lt1" rows="4" class="w-full p-4 serif-font text-lg rounded-xl border border-blue-100 focus:border-blue-400 outline-none bg-blue-50/10 shadow-inner" placeholder="Ghi lại nội dung em định nói..."></textarea>
                                        <div class="mt-3 flex gap-3">
                                            <button onclick="checkParagraphAI('v231-lt1')" class="px-5 py-2 bg-blue-600 text-white font-bold rounded-xl shadow-md border-0 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                                <span>CHẤM BÀI</span>
                                            </button>
                                        ...
                                        <div id="fb-v231-lt1" class="hidden mt-3 p-4 bg-blue-50 border border-blue-100 rounded-xl italic text-sm"></div>
                                    </div>

                                    <div class="bg-white rounded-3xl p-6 shadow-sm border border-blue-100" id="block-v231-lt2">
                                        <div class="flex items-start gap-4 mb-4">
                                            <div class="bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0 mt-1 shadow-md">2</div>
                                            <p class="text-xl font-bold text-gray-800 leading-relaxed">Tìm đọc một cuốn sách viết về một miền đất (Ví dụ: <span class="italic text-blue-700">Phía tây Trường Sơn</span> của Vũ Hùng; <span class="italic text-blue-700">Quê nội</span> của Võ Quảng;...).</p>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <span class="font-bold text-blue-700">Tên sách em đã đọc:</span>
                                            <input type="text" id="v231-lt2-book" class="flex-1 p-3 rounded-xl border border-blue-100 outline-none focus:border-blue-400 bg-amber-50/30" placeholder="Ví dụ: Đất rừng phương Nam">
                                    ...
                                    <div class="mt-10 p-8 bg-gray-900 rounded-[32px] shadow-2xl border-4 border-gray-800 text-center animate-in slide-in-from-bottom-10">
                                        <h4 class="text-lg md:text-2xl font-black text-white uppercase tracking-widest mb-4 italic">Hoàn tất bài học</h4>
