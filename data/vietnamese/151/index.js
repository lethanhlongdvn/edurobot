export const lesson151 = {
    ...
    "content": `<div class="space-y-8 animate-in fade-in duration-700">
                                ...
                                <section class="w-full">
                                    <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl relative overflow-hidden">
                                        ...
                                        <div class="relative z-10">
                                            ...
                                            <div onclick="window.showMathFeedback('Khu rừng của Mát', '🌳', '&lt;div class=&quot;text-center p-4 bg-gradient-to-br from-sky-50 to-blue-50 rounded-[32px] border-4 border-white shadow-xl&quot;&gt;&lt;img src=&quot;assets/images/tiengviet_5_2/151-152/151-152.png&quot; class=&quot;max-h-[70vh] mx-auto rounded-2xl shadow-md object-contain&quot; alt=&quot;Minh họa Khu rừng của Mát&quot;&gt;&lt;p class=&quot;text-2xl font-bold text-blue-600 mt-4&quot;&gt;Cậu bé Mát đi trồng rừng hồi sinh trang trại của tổ tiên.&lt;/p&gt;&lt;/div&gt;')" class="float-none md:float-right w-full md:w-[35%] md:ml-8 mb-6 md:mb-2 bg-gradient-to-br from-sky-50 to-blue-50 rounded-3xl border-4 border-white shadow-lg cursor-pointer hover:scale-105 active:scale-95 transition-all overflow-hidden relative group shrink-0">
                                                <img src="assets/images/tiengviet_5_2/151-152/151-152.png" alt="Minh họa" class="w-full h-auto object-contain group-hover:scale-105 transition-transform duration-500">
                                            ...
                                            <!-- Content -->
                                            <div class="serif-font text-gray-800 leading-relaxed text-justify reading-content text-xl md:text-4xl">
                                                ...
                                                <p class="text-right font-black text-blue-600 uppercase tracking-widest text-base mt-8 clear-both pt-4 border-t border-gray-100/50">(Theo Lô Trân Trân, Thiện Minh dịch)</p>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section class="w-full">
                                    <div class="glass-card rounded-[32px] p-8 shadow-xl border-t-4 border-amber-400 bg-amber-50/30">
                                        <div class="flex items-center space-x-4 mb-6">
                                            ...
                                            <h2 class="text-xl md:text-3xl font-black text-gray-800 uppercase tracking-tight">Tìm hiểu bài</h2>
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="accordion-item bg-white/80 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden">
                                                <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                                    <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">1. Hãy giới thiệu về "Trang trại rừng" và sự gắn bó của Mát với trang trại.</span>
                                                ...
                                                <div class="accordion-content">
                                                    <div class="px-6 pb-6 pt-4 text-gray-700 leading-relaxed border-t border-gray-100 bg-blue-50/30 text-lg md:text-3xl">
                                            ...
                                            <div class="accordion-item bg-white/80 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden">
                                                <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                                    <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">2. Sự việc gì đã xảy ra với trang trại? Điều đó khiến Mát rơi vào tình trạng như thế nào?</span>
                                                    <div class="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center shrink-0 ml-2 group-hover:bg-blue-100 transition-colors"><span class="text-blue-600 font-bold text-lg md:text-3xl">?</span></div>
                                                </button>
                                                <div class="accordion-content">
                                                    <div class="px-6 pb-6 pt-4 text-gray-700 leading-relaxed border-t border-gray-100 bg-blue-50/30 text-lg md:text-3xl">
                                            ...
                                            <div class="accordion-item bg-white/80 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden">
                                                <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                                    <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">3. Nói về những việc Mát đã làm để khôi phục trang trại.</span>
                                                    <div class="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center shrink-0 ml-2 group-hover:bg-blue-100 transition-colors"><span class="text-blue-600 font-bold text-lg md:text-3xl">?</span></div>
                                                </button>
                                                <div class="accordion-content">
                                                    <div class="px-6 pb-6 pt-4 text-gray-700 leading-relaxed border-t border-gray-100 bg-blue-50/30 text-lg md:text-3xl">
                                            ...
                                            <div class="accordion-item bg-white/80 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden">
                                                <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                                    <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">4. Theo em, vì sao Mát bừng tỉnh, quyết tâm khôi phục trang trại khi nghe bà cụ nói: "Cây bị thiêu cháy thì trồng lại là được. Cậu còn trẻ mà!"?</span>
                                                    <div class="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center shrink-0 ml-2 group-hover:bg-blue-100 transition-colors"><span class="text-blue-600 font-bold text-lg md:text-3xl">?</span></div>
                                                </button>
                                                <div class="accordion-content">
                                                    <div class="px-6 pb-6 pt-4 text-gray-700 leading-relaxed border-t border-gray-100 bg-blue-50/30 text-lg md:text-3xl">
                                            ...
                                            <div class="accordion-item bg-white/80 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden">
                                                <button onclick="toggleAccordion(this)" class="w-full p-5 text-left flex justify-between items-start group">
                                                    <span class="font-bold text-gray-800 group-hover:text-blue-600 text-lg md:text-3xl">5. Nêu cảm nghĩ của em về nhân vật Mát trong câu chuyện trên.</span>
                                                    <div class="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center shrink-0 ml-2 group-hover:bg-blue-100 transition-colors"><span class="text-blue-600 font-bold text-lg md:text-3xl">?</span></div>
                                                </button>
                                                <div class="accordion-content">
                                                    <div class="px-6 pb-6 pt-4 text-gray-700 leading-relaxed border-t border-gray-100 bg-blue-50/30 text-lg md:text-3xl">
                                ...
                                <section class="w-full">
                                    <div class="bg-gradient-to-r from-blue-800 to-blue-900 rounded-[32px] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden transform hover:scale-[1.01] transition-transform">
                                ...
                                <section class="w-full">
                                    <div class="glass-card rounded-[32px] p-8 shadow-xl border-t-4 border-green-500 bg-green-50/30">
                                        <div class="flex items-center space-x-4 mb-6">
                                            ...
                                            <h2 class="text-xl md:text-3xl font-black text-gray-800 uppercase tracking-tight">Luyện từ và câu</h2>
                                        </div>
