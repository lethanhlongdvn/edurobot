...
window.submitVn55Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 55',
            '📝',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">✍️</span><p class="text-lg md:text-2xl font-bold text-amber-600">Chúc mừng em đã hoàn thành bài thực hành Đánh giá, chỉnh sửa!</p><p class="text-lg text-gray-800 mt-3">Kỹ năng tự biên tập và nâng cấp câu chữ là vô cùng quan trọng đối với mỗi nhà văn tương lai. Hãy luôn trau chuốt từng lời văn của mình nhé.</p></div>'
        );
    }
};
