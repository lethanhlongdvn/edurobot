...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto text-blue-600">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="flex justify-end items-center gap-4"><button onclick="kiemTraTieuChi104();" class="w-12 h-12 bg-orange-500 hover:bg-orange-600 text-white rounded-full flex items-center justify-center font-black text-xl shadow-md transition-all active:scale-95 shrink-0">E</button></div>
...
<div class="space-y-10 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <section class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="space-y-4 max-w-4xl mx-auto">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-end items-center gap-4"><button onclick="kiemTraChinhSua104();" class="w-12 h-12 bg-orange-500 hover:bg-orange-600 text-white rounded-full flex items-center justify-center font-black text-xl shadow-md transition-all active:scale-95 shrink-0">E</button></div>
    ...
    <section class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="flex justify-end items-center gap-4"><button onclick="kiemTraSauChinhSua104();" class="w-12 h-12 bg-orange-500 hover:bg-orange-600 text-white rounded-full flex items-center justify-center font-black text-xl shadow-md transition-all active:scale-95 shrink-0">E</button></div>
