...
<div class="space-y-8 animate-in fade-in duration-700 max-w-4xl mx-auto">
    ...
    <section class="w-full">
        <div class="bg-white rounded-[40px] p-6 md:p-10 border border-slate-100 shadow-xl space-y-6">
            ...
            <!-- Gửi EduRobot -->
            <div class="flex justify-end items-center gap-4"><button onclick="check177EditAI();" class="w-12 h-12 bg-orange-500 hover:bg-orange-600 text-white rounded-full flex items-center justify-center font-black text-xl shadow-md transition-all active:scale-95 shrink-0">E</button></div>
            </div>
        </div>
    </section>
