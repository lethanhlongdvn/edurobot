...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-sky-50">
        <div class="p-6 md:p-8 bg-sky-50/30 rounded-[32px]">
            ...
            <div class="flex items-center gap-4">
                <button id="btn-check-114-1" onclick="window.checkMatchingVn114()" class="w-14 h-14 md:w-20 md:h-20 bg-sky-600 hover:bg-sky-700 text-white rounded-[1.5rem] font-black text-2xl md:text-4xl shadow-xl transition-all active:scale-95 flex items-center justify-center shrink-0">E</button>
                <button onclick="window.resetMatchingVn114()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all text-base md:text-lg">LÀM LẠI</button>
            </div>
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-sky-50">
        <div class="p-6 md:p-8 bg-sky-50/30 rounded-[32px]">
            ...
            <div class="mt-8 flex justify-center gap-4">
                <button id="btn-check-114-2" onclick="window.checkMozartVn114()" class="w-14 h-14 md:w-20 md:h-20 bg-sky-600 hover:bg-sky-700 text-white rounded-[1.5rem] font-black text-2xl md:text-4xl shadow-xl transition-all active:scale-95 flex items-center justify-center shrink-0">E</button>
                <button onclick="window.resetMozartVn114()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all text-base md:text-lg">LÀM LẠI</button>
            </div>
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-sky-50">
        <div class="p-6 md:p-8 bg-sky-50/30 rounded-[32px]">
            ...
            <!-- Nút kiểm tra bài 3 -->
            <div class="mt-8 flex justify-center gap-4">
                <button id="btn-check-114-3" onclick="window.checkCompleteSentenceVn114()" class="w-14 h-14 md:w-20 md:h-20 bg-sky-600 hover:bg-sky-700 text-white rounded-[1.5rem] font-black text-2xl md:text-4xl shadow-xl transition-all active:scale-95 flex items-center justify-center shrink-0">E</button>
                <button onclick="window.resetCompleteSentenceVn114()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all text-base md:text-lg">LÀM LẠI</button>
            </div>
