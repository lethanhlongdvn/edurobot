...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        <div class="flex items-center gap-3 border-b border-blue-100 pb-4">
            <span class="w-12 h-12 rounded-2xl bg-blue-600 text-white font-black flex items-center justify-center text-lg md:text-2xl shadow-md">📄</span>
            <h3 class="text-2xl md:text-3xl font-black text-blue-600">Góc thu hoạch: Phiếu đọc sách của em</h3>
        </div>
        ...
        <div class="max-w-4xl mx-auto bg-amber-50/30 p-6 md:p-8 rounded-[40px] border-2 border-dashed border-amber-200 space-y-6 relative">
            <div class="absolute right-4 top-4 w-16 h-16 bg-amber-100/40 rounded-full flex items-center justify-center text-lg md:text-2xl animate-pulse">⭐</div>
            
            <h4 class="text-lg md:text-2xl font-black text-amber-600 text-center uppercase tracking-wider mb-6">📖 PHIẾU ĐỌC SÁCH CÁ NHÂN</h4>
...
window.nopBai84Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 85',
            '📖',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🌟</span><p class="text-2xl md:text-3xl font-bold text-blue-600">Chúc mừng em đã hoàn thành bài học Đọc mở rộng!</p><p class="text-lg text-gray-800 mt-3">Hãy tiếp tục khám phá thế giới tri thức diệu kỳ qua những cuốn sách hay mỗi ngày nhé!</p></div>'
        );
    }
};
