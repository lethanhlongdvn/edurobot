            ...
            <div class="bg-gradient-to-br from-blue-50 to-sky-50 p-6 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border-4 border-blue-200 shadow-xl relative overflow-hidden">
                <div class="relative z-10 space-y-6">
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <h3 class="text-2xl md:text-3xl font-black text-blue-700 uppercase tracking-wide text-center">TÌM HIỂU BÀI: ÔN TẬP BẢNG ĐƠN VỊ ĐO LƯỜNG</h3>
                    </div>

                    <!-- Grid 4 bảng quy đổi chính -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 font-bold">
                        
                        <!-- 1. Đơn vị Độ dài & Khối lượng -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-blue-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-blue-700 text-xl md:text-2xl">Độ dài & Khối lượng</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• <span class="font-black text-blue-800">Độ dài:</span> Hai đơn vị liền kề gấp/kém nhau <span class="font-black text-blue-700">10 lần</span>.</p>
                                <p class="pl-3 text-xs md:text-sm text-gray-600">1 km = 1 000 m; 1 m = 100 cm; 1 m = 1 000 mm.</p>
                                <p>• <span class="font-black text-blue-800">Khối lượng:</span> Hai đơn vị liền kề gấp/kém nhau <span class="font-black text-blue-700">10 lần</span>.</p>
                                <p class="pl-3 text-xs md:text-sm text-gray-600">1 tấn = 1 000 kg; 1 kg = 1 000 g.</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-emerald-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-emerald-700 text-xl md:text-2xl">Đơn vị Diện tích</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Hai đơn vị diện tích liền kề gấp/kém nhau <span class="font-black text-emerald-700">100 lần</span>.</p>
                                <p>• <span class="font-black text-emerald-800">1 ha = 10 000 m²</span></p>
                                <p>• <span class="font-black text-emerald-800">1 km² = 100 ha = 1 000 000 m²</span></p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-amber-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-amber-700 text-xl md:text-2xl">Đơn vị Thể tích</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• Hai đơn vị thể tích liền kề gấp/kém nhau <span class="font-black text-amber-700">1 000 lần</span>.</p>
                                <p>• <span class="font-black text-amber-800">1 m³ = 1 000 dm³ = 1 000 000 cm³</span></p>
                                <p>• Đổi sang đơn vị dung tích: <span class="font-black text-amber-800">1 dm³ = 1 lít</span></p>
                            </div>
                        </div>

                        <!-- 4. Ứng dụng giải bài toán thực tế -->
                        <div class="bg-white p-6 md:p-8 rounded-[2rem] shadow-md border-t-8 border-rose-500 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="font-black text-rose-700 text-xl md:text-2xl">Ứng dụng thực tế</h4>
                            </div>
                            <div class="space-y-2 text-sm md:text-base text-gray-700">
                                <p>• <span class="font-black text-rose-800">Tính dung tích nước bể cá:</span> Tính V (cm³) → Đổi sang dm³ (lít) → Nhân với tỉ số phần trăm nước trong bể.</p>
                                <p>• <span class="font-black text-rose-800">Bài toán hút nước bể bơi:</span> Phân số nước còn lại = <span class="font-black text-rose-700">1 − (Phân số đã hút)</span>.</p>
                            </div>
                        </div>
            ...
            <div id="ltViewport" style="overflow:hidden; width:100%; position:relative;">
                <div id="ltTrack" class="flex transition-transform duration-500 ease-out" style="width: 100%; display: flex;">
                    ...
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson166_b1" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-blue-500 space-y-6">
                            ...
                            <div class="space-y-6">
                                <!-- a) Đơn vị độ dài -->
                                <div class="bg-blue-50 p-6 rounded-2xl border border-blue-200 space-y-4 font-bold text-lg">
                                ...
                                <!-- b) Đơn vị khối lượng -->
                                <div class="bg-emerald-50 p-6 rounded-2xl border border-emerald-200 space-y-4 font-bold text-lg">
                    ...
                    <!-- Slide 2: Bài 2 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson166_b2" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-emerald-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
                            ...
                            <div class="space-y-6">
                                <!-- a) Đơn vị diện tích -->
                                <div class="bg-amber-50 p-6 rounded-2xl border border-amber-200 space-y-4 font-bold text-lg">
                                ...
                                <!-- b) Đơn vị thể tích -->
                                <div class="bg-rose-50 p-6 rounded-2xl border border-rose-200 space-y-4 font-bold text-lg">
                    ...
                    <!-- Slide 3: Bài 3 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson166_b3" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-amber-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
                    ...
                    <!-- Slide 4: Bài 4 -->
                    <div class="ltTrang" style="width: 100%; min-width: 100%; max-width: 100%; flex-shrink: 0; box-sizing: border-box; padding: 0 1rem;">
                        <div id="lesson166_b4" class="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border-t-[10px] border-rose-500 space-y-6">
                            <div class="flex items-center gap-4 mb-2">
