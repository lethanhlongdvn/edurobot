const metadata = {
    "lessonInfo": {
        ...
        "week": "13",
        "topic": "Hình học",
        "title": "BÀI 26: HÌNH THANG (TIẾT 3 - DIỆN TÍCH HÌNH THANG)",
        "desc": "Tìm hiểu công thức tính diện tích hình thang và thực hành giải các bài toán tính diện tích hình thang trong thực tế."
    },
    "bai_tap": [
        {
            "id": "62_bt1_a",
        ...
        },
        {
            "id": "62_bt3_b",
            "type": "fill_multiple",
            "title": "Bài 3b: Thiết kế lại các phòng theo ý thích của em.",
            "answers": ["Đã hoàn thành"],
            "guidance": "Hãy viết ý tưởng chia phòng của em trên mảnh đất 104 m² này (ví dụ: tăng diện tích phòng khách, thu nhỏ phòng ngủ, hoặc dời vị trí bếp...). Em hãy chia sẻ ý kiến của mình nhé!",
            "solution": "Ý kiến thiết kế sáng tạo của em đã được ghi lại thành công.<br>Ý tưởng rất độc đáo và hợp lý!"
        }
    ],
    "quizPool": [
        { "question": "Công thức tính diện tích hình thang S là gì (a, b là độ dài hai đáy, h là chiều cao)?", "options": ["S = a x h : 2", "S = (a + b) x h : 2", "S = (a + b) x h", "S = (a x b) x h : 2"], "answer": 1 },
        { "question": "Muốn tính diện tích hình thang, ta lấy tổng độ dài hai đáy nhân với chiều cao (cùng đơn vị đo) rồi làm gì tiếp theo?", "options": ["Nhân với 2", "Chia cho 2", "Cộng thêm 2", "Giữ nguyên kết quả"], "answer": 1 },
        { "question": "Một hình thang có đáy lớn 10 cm, đáy bé 6 cm và chiều cao 5 cm. Diện tích của hình thang đó là bao nhiêu?", "options": ["80 cm²", "40 cm²", "30 cm²", "20 cm²"], "answer": 1 },
        { "question": "Một hình thang vuông có chiều cao chính là cạnh nào của nó?", "options": ["Đường chéo", "Cạnh bên vuông góc với hai đáy", "Cạnh đáy lớn", "Cạnh bên xiên"], "answer": 1 },
        { "question": "Hình thang có độ dài hai đáy là 8 dm và 12 dm, chiều cao là 6 dm. Diện tích hình thang đó là:", "options": ["60 dm²", "120 dm²", "48 dm²", "96 dm²"], "answer": 0 },
        { "question": "Để tính diện tích hình thang, hai đáy và chiều cao bắt buộc phải:", "options": ["Có cùng đơn vị đo", "Có độ dài bằng nhau", "Nằm chéo nhau", "Lớn hơn 10 cm"], "answer": 0 },
        { "question": "Diện tích hình thang ABCD có đáy lớn 15 m, đáy bé bằng 2/3 đáy lớn, chiều cao 8 m là bao nhiêu?", "options": ["100 m²", "200 m²", "80 m²", "120 m²"], "answer": 0 },
        { "question": "Một hình thang có diện tích 50 cm², tổng độ dài hai đáy là 20 cm. Chiều cao của hình thang đó là:", "options": ["5 cm", "10 cm", "2.5 cm", "8 cm"], "answer": 0 },
        { "question": "Robot đã đọc bài thơ về diện tích hình thang. Câu đầu tiên của bài thơ đó là gì?", "options": ["Đáy lớn đáy bé ta mang cộng vào", "Muốn tính diện tích hình thang", "Chia đôi kết quả thế nào cũng ra", "Rồi đem nhân với chiều cao"], "answer": 1 },
        { "question": "Khi ghép hình thang ABCD thành hình tam giác ADK để tính diện tích, chiều cao của hình tam giác ADK như thế nào so với hình thang?", "options": ["Gấp đôi", "Bằng nhau (chung đường cao AH)", "Nhỏ hơn một nửa", "Lớn hơn"], "answer": 1 },
        { "question": "Tính diện tích mặt bàn hình thang có đáy bé 60 cm, đáy lớn 120 cm và chiều cao 55 cm.", "options": ["9900 cm²", "4950 cm²", "29700 cm²", "5400 cm²"], "answer": 1 },
        { "question": "Một mảnh đất hình thang vuông có đáy bé 7 m, đáy lớn 9 m và đường cao 13 m. Diện tích mảnh đất là:", "options": ["104 m²", "208 m²", "91 m²", "117 m²"], "answer": 0 },
        { "question": "Nếu tăng chiều cao của một hình thang lên 2 lần và giữ nguyên hai đáy, diện tích hình thang đó thay đổi thế nào?", "options": ["Không đổi", "Tăng 2 lần", "Tăng 4 lần", "Giảm 2 lần"], "answer": 1 },
        { "question": "Hình thang cân có hai cạnh bên bằng nhau. Công thức tính diện tích hình thang cân có khác công thức hình thang thường không?", "options": ["Có khác biệt", "Hoàn toàn giống nhau", "Chỉ tính bằng tổng 4 cạnh", "Không thể tính được"], "answer": 1 },
        { "question": "Một hình thang có diện tích 30 dm², chiều cao 5 dm. Tổng độ dài hai đáy của nó là:", "options": ["12 dm", "6 dm", "15 dm", "24 dm"], "answer": 0 }
    ]
};
...
// Đăng ký toàn cục
window.lesson62 = lesson62;

// --- ĐIỀU HƯỚNG TABS PHỤ BÀI 3 ---
window._62_3_active_tab = 0;
window.switch_62_3_tab = function(index) {
    window._62_3_active_tab = index;
    for (let i = 0; i < 2; i++) {
        const pane = document.getElementById('pane-62-3-' + i);
        const tab = document.getElementById('tab-62-3-' + (i + 1));
        if (pane) {
        ...
        if (tab) {
            if (i === index) {
                tab.className = "px-4 py-2 text-xs md:text-sm font-black rounded-xl bg-blue-600 text-white shadow transition-all";
            } else {
                tab.className = "px-4 py-2 text-xs md:text-sm font-black rounded-xl text-blue-600 hover:bg-blue-200/50 transition-all";
            }
        }
    }
};
...
// --- CHẤM ĐIỂM BÀI 1 ---
window.check_62_bt1 = function() {
    const valA = document.getElementById('ans-62-1-a').value.trim();
    const valB = document.getElementById('ans-62-1-b').value.trim();
    const isCorrectA = (valA === '15');
    const isCorrectB = (valB === '80');
    const isCorrect = isCorrectA && isCorrectB;
    ...
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 1: Tính diện tích hình thang", isCorrect ? 100 : 0, 'btn-check-62-bt1', 0, 2, (isCorrectA ? 1 : 0) + (isCorrectB ? 1 : 0));
    }
};

// --- CHẤM ĐIỂM BÀI 2 ---
window.check_62_bt2 = function() {
    const inputVal = document.getElementById('ans-62-2').value.trim();
    const isCorrect = (inputVal === '29700');
    
    const rightAnswer = "29700 cm²";
    const studentAnswer = inputVal ? inputVal + " cm²" : "Chưa nhập";
    ...
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 2: Tính diện tích mặt bàn đa năng", isCorrect ? 100 : 0, 'btn-check-62-bt2', 0, 1, isCorrect ? 1 : 0);
    }
};

// --- CHẤM ĐIỂM BÀI 3A ---
window.check_62_bt3_a = function() {
    const inputVal = document.getElementById('ans-62-3-a').value.trim();
    const isCorrect = (inputVal === '104');
    
    const rightAnswer = "104 m²";
    const studentAnswer = inputVal ? inputVal + " m²" : "Chưa nhập";
    ...
    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 3a: Tính diện tích mảnh đất", isCorrect ? 100 : 0, 'btn-check-62-bt3-a', 0, 1, isCorrect ? 1 : 0);
    }
};

// --- CHẤM ĐIỂM BÀI 3B ---
window.check_62_bt3_b = function() {
    const inputVal = document.getElementById('ans-62-3-b').value.trim();
    const isCorrect = (inputVal.length >= 3); // Chấp nhận bất kỳ thiết kế nào dài hơn 3 ký tự
    
    const rightAnswer = "Ý tưởng thiết kế phòng hợp lệ";
    const studentAnswer = inputVal ? inputVal : "Chưa nhập";
    const guidance = metadata.bai_tap[4].guidance;
    const solution = metadata.bai_tap[4].solution;

    window.showMathFeedback(isCorrect, rightAnswer, studentAnswer, guidance, solution);

    if (window.submitMathLesson) {
        window.submitMathLesson("Bài 3b: Thiết kế phòng của em", isCorrect ? 100 : 0, 'btn-check-62-bt3-b', 0, 1, isCorrect ? 1 : 0);
    }
};
