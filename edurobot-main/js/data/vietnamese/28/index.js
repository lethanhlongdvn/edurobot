...
window.submitVn28Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 28',
            '🎉',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🎡</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài học nói và nghe!</p><p class="text-2xl md:text-3xl text-gray-800 mt-3">Một người thuyết trình giỏi luôn tự tin và to rõ, đồng thời một người nghe giỏi luôn biết lắng nghe tôn trọng và đặt câu hỏi thông minh.</p></div>'
        );
    }
};
