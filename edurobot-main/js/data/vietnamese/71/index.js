    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-emerald-100 shadow-xl space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-center">
                <button onclick="kiemTraKhoiDong71()" class="px-8 py-3 bg-emerald-600 text-white font-black rounded-xl hover:bg-emerald-600 transition-all text-base shadow-md">GỬI CHIA SẺ ✓</button>
            </div>
            ...
            <div class="space-y-4">
                ...
                <details class="group bg-white rounded-2xl border border-emerald-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-8 pb-6 text-gray-800 leading-relaxed border-t border-emerald-50 pt-4 bg-emerald-50/10 font-medium text-lg md:text-3xl">
                        <p class="text-emerald-800 font-bold mb-2">💡 Gợi ý trả lời:</p>
        ...
        <div class="p-6 md:p-8 bg-amber-50/30 rounded-[32px]">
            ...
            <div class="bg-white p-6 rounded-3xl border border-amber-100 shadow-inner">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <button onclick="checkWritingVn71()" class="px-8 py-3 bg-amber-500 text-white font-black text-lg rounded-2xl shadow-md hover:bg-amber-500 active:scale-95 transition-all flex items-center gap-2">
                        <div class="w-6 h-6 bg-white rounded-lg flex items-center justify-center text-amber-900 font-black text-xs shadow-sm">E</div> 
                        <span>CHẤM BÀI</span>
                    </button>
                    <button onclick="resetWritingVn71()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all">LÀM LẠI</button>
                </div>
            ...
            <div class="flex justify-center">
                <button onclick="kiemTraLuyenTap71()" class="px-8 py-3 bg-emerald-600 text-white font-black rounded-xl hover:bg-emerald-600 transition-all text-base shadow-md">NỘP ĐÁP ÁN ✓</button>
            </div>
