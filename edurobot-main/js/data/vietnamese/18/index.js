    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-sky-100 shadow-xl relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-6">
            ...
            <div class="serif-font text-gray-900 leading-relaxed text-justify space-y-5 bg-sky-50/10 p-6 md:p-8 rounded-3xl border border-sky-100/50 text-xl md:text-4xl">
                ...
                <p class="text-right font-bold text-gray-800 mt-4 text-2xl md:text-3xl">(Theo Lê Khắc Hoan)</p>
            </div>
        </div>
    </div>
...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-sky-50">
        <div class="p-6 md:p-8 bg-sky-50/30 rounded-[32px] space-y-6">
            ...
            <div class="bg-white p-5 rounded-2xl border border-sky-100 space-y-4 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-1">
                        <label class="text-xs font-bold text-gray-800">⏱️ Thời gian xảy ra trận đấu:</label>
                        <select id="vn18-info-time" class="w-full p-2 border border-gray-100 rounded-lg text-sm font-semibold">
                    ...
                    <div class="space-y-1">
                        <label class="text-xs font-bold text-gray-800">📍 Địa điểm thi đấu:</label>
                        <select id="vn18-info-loc" class="w-full p-2 border border-gray-100 rounded-lg text-sm font-semibold">
                    ...
                    <div class="space-y-1">
                        <label class="text-xs font-bold text-gray-800">👤 Nhân vật chính kể chuyện:</label>
                        <select id="vn18-info-main" class="w-full p-2 border border-gray-100 rounded-lg text-sm font-semibold">
                ...
                <div class="flex justify-center">
                    <button onclick="checkInfoVn18()" class="px-6 py-2 bg-sky-600 text-white font-black rounded-xl hover:bg-sky-600 transition-all text-sm">KIỂM TRA THÔNG TIN ✓</button>
                </div>
            ...
            <div class="space-y-4">
                ...
                <details class="group bg-white rounded-2xl border border-sky-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-8 pb-6 text-gray-800 leading-relaxed border-t border-sky-50 pt-4 bg-sky-50/10 font-medium space-y-2 text-lg md:text-3xl">
                        <p class="text-sky-800 font-bold">💡 Gợi ý trả lời:</p>
    ...
    <!-- PHẦN 2: LUYỆN TỪ VÀ CÂU (TÌM TỪ BÓNG ĐÁ + ĐẠI TỪ THAY THẾ) -->
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-red-50">
        <div class="p-6 md:p-8 bg-red-50/30 rounded-[32px] space-y-6">
            <div class="flex items-center gap-4 mb-2">
                <div class="w-12 h-12 bg-red-600 text-white rounded-xl flex items-center justify-center text-2xl md:text-5xl font-black shadow-md">🔍</div>
            ...
            <div class="bg-white p-5 rounded-2xl border border-red-100 space-y-4">
                <p class="text-2xl md:text-3xl text-gray-800 font-bold">1. Phân loại từ ngữ chỉ <strong>sự vật</strong> (Click chọn chuyển màu đỏ) và <strong>hoạt động</strong> (Click chọn chuyển màu xanh lá) trong trận bóng đá ở đoạn dưới:</p>
            ...
            <!-- Bài 3: Đại từ thay thế trong câu nối tiếp -->
            <div class="bg-white p-5 rounded-2xl border border-red-100 space-y-4">
                <p class="text-2xl md:text-3xl text-gray-800 font-bold">2. Chọn câu đặt nối tiếp có sử dụng đại từ thay thế phù hợp cho phần in đậm:</p>
                ...
                <div class="flex justify-center">
                    <button onclick="checkBai3Vn18()" class="px-8 py-3 bg-red-600 text-white font-black rounded-xl hover:bg-red-600 transition-all text-base shadow-md">KIỂM TRA CÂU DÙNG ĐẠI TỪ ✓</button>
                </div>
        ...
        <div class="p-6 md:p-8 bg-amber-50/30 rounded-[32px] space-y-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-amber-100 shadow-inner space-y-4">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <button onclick="checkWritingVn18()" class="px-8 py-3 bg-amber-500 text-white font-black text-lg rounded-2xl shadow-md hover:bg-amber-500 active:scale-95 transition-all flex items-center gap-2">
                    ...
                    <button onclick="resetWritingVn18()" class="px-6 py-3 bg-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-300 transition-all text-base">LÀM LẠI</button>
                </div>
...
window.nopBaiVn18 = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback('Hoàn thành Tiết 18-19', '⚽', '<div class="text-center p-6"><span class="text-7xl block mb-4">⚽</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài học Ngôi sao sân cỏ!</p><p class="text-lg text-gray-800 mt-3">Đoàn kết và phối hợp cùng đồng đội là bài học ý nghĩa nhất để đi tới thành công.</p></div>');
    }
};
