...
window.nopBaiVn20 = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 20',
            '📝',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">📝</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã tìm hiểu xong cách viết báo cáo công việc!</p><p class="text-2xl md:text-3xl text-gray-800 mt-3">Một báo cáo khoa học, rõ ràng sẽ giúp công việc được quản lý hiệu quả và chuyên nghiệp.</p></div>'
        );
    }
};
