...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-sky-100 shadow-xl space-y-6">
        ...
        <div class="bg-sky-50/30 p-6 rounded-3xl border border-sky-100/50 max-w-xl mx-auto space-y-4">
            <div class="text-center font-bold text-2xl text-sky-800 py-2">
...
window.submitVn51Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 51',
            '📝',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">✍️</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài học Luyện từ và câu: Luyện tập về từ đa nghĩa!</p><p class="text-lg text-gray-800 mt-3">Hãy tiếp tục tích lũy vốn từ và sử dụng từ đa nghĩa một cách sinh động, hiệu quả trong giao tiếp hàng ngày nhé.</p></div>'
        );
    }
};
