        ...
        <div class="relative z-10 space-y-6">
            ...
            <div class="bg-slate-50 p-6 md:p-8 rounded-[32px] border border-gray-100/50 space-y-4 max-w-3xl mx-auto font-semibold">
                ...
                <div class="flex flex-col items-start space-y-1">
                    <span class="text-xs font-black text-indigo-800 pl-2">🕵️ Sơ-lốc Hôm:</span>
                    <div class="bg-indigo-50 text-indigo-800 p-4 rounded-3xl rounded-tl-none border border-indigo-100 text-xl md:text-2xl space-y-2">
                        <p>– (4) Oát-xơn, nhìn xem, 
                            <select id="vn23-hoa-1" class="p-1 border border-indigo-100 rounded font-bold mx-1 text-slate-800">
                ...
                <div class="flex flex-col items-start space-y-1">
                    <span class="text-xs font-black text-indigo-800 pl-2">🕵️ Sơ-lốc Hôm:</span>
                    <div class="bg-indigo-50 text-indigo-800 p-4 rounded-3xl rounded-tl-none border border-indigo-100 text-xl md:text-2xl">
                ...
                <div class="flex flex-col items-start space-y-1">
                    ...
                    <div class="bg-indigo-50 text-indigo-800 p-4 rounded-3xl rounded-tl-none border border-indigo-100 text-xl md:text-2xl space-y-2">
                        <p>– (9) Theo 
                            <select id="vn23-hoa-6" class="p-1 border border-indigo-100 rounded font-bold mx-1 text-slate-800">
                                <option value="">Chọn...</option>
                                <option value="anh">anh</option>
                                <option value="tôi">tôi</option>
                                <option value="chúng ta">chúng ta</option>
                            ...
                            <select id="vn23-hoa-7" class="p-1 border border-indigo-100 rounded font-bold mx-1 text-slate-800">
                                <option value="">Chọn...</option>
                                <option value="anh">anh</option>
                                <option value="tôi">tôi</option>
                                <option value="chúng ta">chúng ta</option>
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-sky-50">
        <div class="p-6 md:p-8 bg-sky-50/30 rounded-[32px] space-y-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-sky-100 shadow-sm space-y-4">
                <div class="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100 text-indigo-800 font-bold text-xl md:text-2xl">
...
window.nopBaiVn23 = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 23',
            '✏️',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">✏️</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài học Luyện tập về đại từ!</p><p class="text-lg text-gray-800 mt-3">Sử dụng đại từ xưng hô khéo léo và đại từ thay thế phù hợp giúp các câu văn liên kết tự nhiên, mạch lạc hơn.</p></div>'
        );
    }
};
