...
window.nopBaiTiet38Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 38',
            '✍️',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">✍️</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành xuất sắc Tiết 38: Viết mở bài và kết bài cho bài văn tả phong cảnh!</p><p class="text-xl text-gray-800 mt-3">Giờ đây em đã làm chủ kỹ thuật mở bài gián tiếp và kết bài mở rộng để tạo nên những bài văn tả cảnh tuyệt vời!</p></div>'
        );
    }
};
