    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-emerald-100 shadow-xl space-y-6 relative">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-emerald-100 pb-6 text-lg md:text-3xl">
            <div>
                ...
                <h3 class="text-3xl font-black text-emerald-900 mt-2">Giới thiệu sách DẾ MÈN PHIÊU LƯU KÍ</h3>
            </div>
...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-emerald-100 shadow-xl space-y-8">
        <div class="flex items-center gap-3 border-b border-emerald-100 pb-4">
            <span class="w-12 h-12 rounded-2xl bg-emerald-600 text-white font-black flex items-center justify-center text-2xl shadow-md">❓</span>
        ...
        <div class="space-y-4">
            ...
            <div class="max-w-4xl mx-auto bg-emerald-50/30 p-6 rounded-3xl border border-emerald-100/50 space-y-4">
                ...
                <div class="flex justify-center pt-2">
                    <button onclick="checkMatchVn85()" class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-black rounded-xl active:scale-95 transition-all text-base shadow">NỘP BÀI ✓</button>
                </div>
        ...
        <div class="space-y-4">
            ...
            <div class="max-w-4xl mx-auto bg-emerald-50/30 p-6 rounded-3xl border border-emerald-100/50 space-y-4">
                ...
                <div class="flex justify-center pt-2">
                    <button onclick="checkNumbersVn85()" class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-black rounded-xl active:scale-95 transition-all text-base shadow">NỘP BÀI ✓</button>
                </div>
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-4 max-w-4xl mx-auto">
                ...
                <div class="flex justify-center gap-3">
                    <button onclick="checkWritingVn85()" class="px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-lg rounded-2xl shadow-lg hover:shadow-xl active:scale-95 transition-all flex items-center gap-2">
                        <span>🎓</span> CHẤM ĐIỂM AI THẦY E
                    </button>
                    <button onclick="resetVn85()" class="px-6 py-4 bg-gray-200 hover:bg-gray-300 text-gray-700 font-black text-lg rounded-2xl active:scale-95 transition-all">LÀM LẠI</button>
                </div>
