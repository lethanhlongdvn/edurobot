...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto text-blue-900">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between border-b border-blue-100 pb-4">
            ...
            <div class="relative group cursor-pointer overflow-hidden rounded-xl border border-blue-200 max-w-[120px]"
                ...
                <div class="absolute inset-0 bg-blue-900/10 opacity-0 group-hover:opacity-100 flex items-center justify-center rounded-lg">
                    <span class="bg-white/95 px-2 py-1 rounded text-xs font-black text-blue-900">XEM ĐỀ SGK</span>
                </div>
            </div>
        </div>
    ...
    <div id="sec-prep-vn97" class="hidden bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div class="lg:col-span-2 space-y-6">
                <!-- Chọn bài thơ gợi ý -->
                <div class="space-y-3">
                    <span class="font-black text-blue-900 text-xl">a. Lựa chọn bài thơ mà em muốn viết:</span>
                ...
                <div class="space-y-3 border-t border-blue-50 pt-4">
                    <span class="font-black text-blue-900 text-xl">b. Ghi nhanh những điều em yêu thích ở bài thơ đó:</span>
            ...
            <div class="flex flex-col items-center justify-center bg-blue-50/20 p-4 rounded-[2rem] border border-blue-100">
                <div class="relative group cursor-pointer overflow-hidden rounded-[2rem] border-2 border-blue-200 shadow-md p-1 bg-white max-w-[200px]"
                    ...
                    <div class="absolute inset-0 bg-blue-900/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-[1.5rem]">
                        <span class="bg-white/95 px-3 py-1.5 rounded-full text-xs font-black text-blue-900 shadow">🔍 XEM TRANH</span>
                    </div>
                </div>
    ...
    <div id="sec-outline-vn97" class="hidden bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="p-5 bg-blue-50/30 rounded-2xl border-2 border-blue-100 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        <span class="font-bold text-blue-900 text-lg">a. Những chi tiết nghệ thuật, nội dung em yêu thích:</span>
                    ...
                    <div class="space-y-2">
                        <span class="font-bold text-blue-900 text-lg">b. Cảm xúc, tình cảm cụ thể của em về bài thơ:</span>
        ...
        <div class="flex justify-center pt-2">
            <button onclick="checkOutlineVn97()" class="w-14 h-14 md:w-20 md:h-20 bg-blue-700 hover:bg-blue-800 text-white rounded-[2rem] font-black text-3xl flex items-center justify-center shadow-lg active:scale-95 transition-all">E</button>
        </div>
    ...
    <div id="sec-audit-vn97" class="hidden bg-white p-6 md:p-8 rounded-[2.5rem] border-2 border-blue-100 space-y-6">
        ...
        <div class="max-w-4xl mx-auto bg-blue-50/30 p-6 rounded-[2rem] border border-blue-100 space-y-4">
            ...
            <div class="space-y-3 font-semibold text-lg text-gray-800 ml-4">
                ...
                <li class="flex flex-col md:flex-row md:items-center gap-2">
                    <span class="font-black text-blue-900 flex items-center gap-1">🌹 Tiêu chí thứ tư cần bổ sung là:</span>
                    <select id="vn97-c3-flower" class="p-2 border border-blue-300 rounded-xl outline-none bg-white font-bold text-blue-900 text-base mt-2 md:mt-0">
        ...
        <div class="flex justify-center pt-2">
            <button onclick="checkFlowerVn97()" class="w-14 h-14 md:w-20 md:h-20 bg-blue-700 hover:bg-blue-800 text-white rounded-[2rem] font-black text-3xl flex items-center justify-center shadow-lg active:scale-95 transition-all">E</button>
        </div>
