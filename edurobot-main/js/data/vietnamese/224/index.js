export const lesson224 = {
    ...
    "audio": "assets/audio/tiengviet/vethamdatmui.mp3",
    "content": `
...
<div class="flex flex-col lg:flex-row gap-6">
                                ...
                                <aside class="w-full lg:w-[25%]">
                                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl">
                                        <div class="mb-6"><img src="assets/images/datmui.webp" alt="Minh họa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl"></div>
...
if (!lesson_262_ve_tham_dat_mui.period) lesson224.period = "262";
if (!lesson_262_ve_tham_dat_mui.id) lesson224.id = "262-ve-tham-dat-mui";
