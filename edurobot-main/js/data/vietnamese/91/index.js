...
<div class="flex justify-end mb-4">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-6">
        <h3 class="text-2xl md:text-5xl font-black text-indigo-800 border-b border-indigo-100 pb-4 flex items-center gap-3">
        ...
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            <div class="bg-indigo-50/50 p-5 rounded-2xl border-2 border-indigo-100 flex flex-col justify-between space-y-3">
                <span class="font-black text-lg text-indigo-900">📚 Mạc Đĩnh Chi</span>
                <select id="vn91-start-mac" class="p-3 border border-indigo-200 rounded-xl font-bold bg-white text-base">
            ...
            <div class="bg-indigo-50/50 p-5 rounded-2xl border-2 border-indigo-100 flex flex-col justify-between space-y-3">
                <span class="font-black text-lg text-indigo-900">📚 Lương Thế Vinh</span>
                <select id="vn91-start-luong" class="p-3 border border-indigo-200 rounded-xl font-bold bg-white text-base">
                    <option value="">-- Chọn câu chuyện --</option>
                    <option value="book">Nổi tiếng tự học bằng cách bắt đom đóm bỏ vào vỏ trứng lấy ánh sáng đọc sách ban đêm</option>
                    <option value="math">Nổi tiếng thần đồng toán học, tự nghĩ ra cách đo bóng cây để tính chiều cao tháp</option>
                    <option value="eng">Tấm gương tự học toàn diện ngoại ngữ, nói tiếng Anh trôi chảy và tự dịch tiếng Nga trong 3 tháng</option>
            ...
            <div class="bg-indigo-50/50 p-5 rounded-2xl border-2 border-indigo-100 flex flex-col justify-between space-y-3">
                <span class="font-black text-lg text-indigo-900">📚 Tạ Quang Bửu</span>
                <select id="vn91-start-ta" class="p-3 border border-indigo-200 rounded-xl font-bold bg-white text-base">
                    <option value="">-- Chọn câu chuyện --</option>
                    <option value="book">Nổi tiếng tự học bằng cách bắt đom đóm bỏ vào vỏ trứng lấy ánh sáng đọc sách ban đêm</option>
                    <option value="math">Nổi tiếng thần đồng toán học, tự nghĩ ra cách đo bóng cây để tính chiều cao tháp</option>
                    <option value="eng">Tấm gương tự học toàn diện ngoại ngữ, nói tiếng Anh trôi chảy và tự dịch tiếng Nga trong 3 tháng</option>
        ...
        <div class="flex justify-center pt-2">
            <button onclick="checkStartVn91()" class="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-lg rounded-2xl shadow active:scale-95 transition-all">KIỂM TRA GHÉP NỐI</button>
        </div>
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-6">
        ...
        <div class="max-w-4xl mx-auto space-y-5 pt-2">
            <div class="bg-indigo-50/20 p-5 rounded-2xl border border-indigo-100 space-y-2">
                <label class="text-base font-black text-indigo-950 block">a) Thế nào là tự học?</label>
                <input type="text" id="vn91-prep-a" placeholder="Nhập cách hiểu của em... Ví dụ: Tự tìm hiểu kiến thức, không cần người khác nhắc nhở..." class="w-full p-3 border-2 border-indigo-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
            </div>

            <div class="bg-indigo-50/20 p-5 rounded-2xl border border-indigo-100 space-y-2">
                <label class="text-base font-black text-indigo-950 block">b) Lợi ích của tự học đem lại cho em là gì?</label>
                <input type="text" id="vn91-prep-b" placeholder="Nhập lợi ích... Ví dụ: Giúp em nhớ lâu hơn, rèn phẩm chất chăm chỉ..." class="w-full p-3 border-2 border-indigo-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
            </div>

            <div class="bg-indigo-50/20 p-5 rounded-2xl border border-indigo-100 space-y-2">
                <label class="text-base font-black text-indigo-950 block">c) Gương tự học nào mà em biết và ấn tượng nhất?</label>
                <input type="text" id="vn91-prep-c" placeholder="Nhập tên tấm gương tự học... Ví dụ: Bác Hồ tự học ngoại ngữ, bạn học sinh nghèo vượt khó..." class="w-full p-3 border-2 border-indigo-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
            </div>

            <div class="flex justify-center">
                <button onclick="savePrepVn91()" class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-lg rounded-2xl shadow active:scale-95 transition-all">LƯU Ý KIẾN CHUẨN BỊ 💾</button>
            </div>
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-8">
        ...
        <div class="space-y-4 max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-gradient-to-br from-indigo-50 to-indigo-100/50 p-5 rounded-2xl border border-indigo-200 shadow-sm text-center">
                    <span class="text-3xl block mb-2">💡</span>
                    <h5 class="font-black text-indigo-900 text-base mb-1">Cách hiểu về tự học</h5>
                    <p class="text-sm font-bold text-indigo-800 leading-relaxed">Là quá trình tự tìm hiểu các kiến thức cần thiết cho mình, không ỷ lại hay phụ thuộc hoàn toàn vào người khác.</p>
                </div>
        ...
        <div class="bg-indigo-50/30 p-6 md:p-8 rounded-[36px] border border-indigo-100 max-w-3xl mx-auto space-y-4 shadow-inner">
            <h4 class="text-lg font-black text-indigo-900 text-center flex items-center justify-center gap-2">
                <span>🎙️</span> LUYỆN TẬP PHÁT BIỂU VÀ THU ÂM BÀI NÓI
            </h4>
            <p class="text-sm text-indigo-800 text-center font-bold">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-6">
        ...
        <div class="max-w-4xl mx-auto space-y-4">
            <div class="flex flex-col md:flex-row items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <span class="w-12 h-12 bg-indigo-100 text-indigo-800 font-black rounded-full flex items-center justify-center text-lg shrink-0">📊</span>
                ...
                <input type="checkbox" class="w-6 h-6 text-indigo-600 focus:ring-indigo-500 rounded">
            </div>
        ...
        <div class="bg-indigo-50 bg-opacity-40 p-6 rounded-3xl border-2 border-dashed border-indigo-200 text-center max-w-4xl mx-auto shadow-sm">
            <h4 class="font-black text-indigo-900 text-lg mb-2">🏠 Liên hệ thực tế & Vận dụng</h4>
            <p class="text-indigo-800 font-bold leading-relaxed text-base">
