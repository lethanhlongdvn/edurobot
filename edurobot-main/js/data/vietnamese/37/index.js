...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto py-6 font-medium">
    ...
    <section class="bg-white p-6 md:p-8 rounded-[36px] border border-sky-100 shadow-xl space-y-6">
        ...
        <div class="flex flex-col items-center gap-2 pt-4">
            <button onclick="checkIdioms37()" class="w-16 h-16 bg-sky-600 text-white rounded-2xl font-black text-3xl flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all">E</button>
    ...
    <section class="bg-white p-6 md:p-8 rounded-[36px] border border-sky-100 shadow-xl space-y-6">
        ...
        <div class="flex flex-col items-center gap-2 pt-4">
            <button onclick="checkPoetrySynonyms37()" class="w-16 h-16 bg-sky-600 text-white rounded-2xl font-black text-3xl flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all">E</button>
            <span class="text-xs font-bold text-sky-800 uppercase tracking-widest">Đánh giá</span>
        </div>
    ...
    <section class="bg-white p-6 md:p-8 rounded-[36px] border border-sky-100 shadow-xl space-y-6">
        ...
        <div class="p-8 bg-sky-50/20 rounded-[32px] border border-sky-100 shadow-inner">
            <h4 class="text-2xl font-black text-center text-gray-800 mb-6">Mưa mùa xuân</h4>
        ...
        <div class="flex flex-col items-center gap-2 pt-4">
            <button onclick="checkSpringRain37()" class="w-16 h-16 bg-sky-600 text-white rounded-2xl font-black text-3xl flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all">E</button>
            <span class="text-xs font-bold text-sky-800 uppercase tracking-widest">Đánh giá</span>
        </div>
    ...
    <section class="bg-gradient-to-br from-sky-600 to-sky-500 text-white p-6 md:p-8 rounded-[36px] shadow-xl space-y-6">
        ...
        <div class="bg-white/10 backdrop-blur-md p-6 rounded-[28px] border border-white/20 shadow-inner space-y-4">
            ...
            <div class="flex flex-col items-center gap-2 pt-2">
                <button onclick="gradeParagraph37()" class="w-20 h-20 bg-white text-sky-800 rounded-[2rem] font-black text-4xl flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all ring-4 ring-white/10">E</button>
...
<div id="vn37-feedback-overlay" class="hidden fixed inset-0 bg-slate-100/60 backdrop-blur-sm z-[9937] flex items-center justify-center p-4 animate-in fade-in duration-337">
  <div class="bg-white rounded-[32px] shadow-2xl max-w-xl w-full p-8 relative overflow-hidden border-4 border-sky-100 animate-in zoom-in-95 duration-337">
    <div id="vn37-feedback-header" class="text-sky-900 font-black text-2xl md:text-3xl mb-4 flex items-center gap-3">
      <span id="vn37-feedback-icon" class="text-4xl">💡</span>
...
window.submitVn37Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 37',
            '🌟',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🌟</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành Tiết 37: Luyện tập về từ đồng nghĩa!</p><p class="text-xl text-gray-800 mt-3">Học tốt từ đồng nghĩa sẽ giúp em viết các đoạn văn tả cảnh trở nên sinh động, uyển chuyển và hấp dẫn hơn rất nhiều.</p></div>'
        );
    }
};
