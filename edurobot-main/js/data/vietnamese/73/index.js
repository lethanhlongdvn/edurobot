    ...
    <section class="bg-white p-6 md:p-10 rounded-[48px] border border-emerald-100 shadow-xl relative overflow-hidden">
        <div class="relative z-10 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto py-2">
                ...
                <label class="p-5 rounded-3xl border border-indigo-100 bg-indigo-50 bg-opacity-40 flex items-start gap-4 cursor-pointer hover:bg-indigo-50 transition-all select-none">
                    <input type="checkbox" id="chk-danchung" class="w-6 h-6 rounded text-indigo-800 focus:ring-indigo-600 mt-1">
                    <div class="space-y-1">
                        <span class="text-lg font-black text-indigo-800 block">Dẫn chứng minh họa</span>
                        <span class="text-base text-indigo-800 font-bold block">Có đưa ra được dẫn chứng, hành động, hoặc chi tiết cụ thể từ cuốn sách để làm rõ đặc điểm nhân vật.</span>
                    </div>
                </label>
            </div>
