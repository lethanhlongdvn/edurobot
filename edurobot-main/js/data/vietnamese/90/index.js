...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        <h3 class="text-2xl md:text-3xl font-black text-blue-800 border-b border-blue-100 pb-4 flex items-center gap-3">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="bg-blue-50/50 p-6 rounded-3xl border border-blue-100 space-y-4">
                <span class="text-sm font-black text-blue-800 bg-blue-100 px-3 py-1 rounded-full uppercase tracking-wider">Tiêu chí 1: Nội dung & Cảm xúc</span>
                <div class="space-y-3">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="space-y-4 max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-br from-amber-50 to-orange-50/50 p-6 md:p-8 rounded-[32px] border-2 border-dashed border-amber-200 relative shadow-inner">
                <div class="absolute right-4 bottom-4 w-12 h-12 bg-amber-100/50 rounded-full flex items-center justify-center text-2xl">🖋️</div>
