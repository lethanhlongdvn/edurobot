    ...
    <section class="w-full">
        <div class="bg-white rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-xl space-y-6">
            ...
            <div class="flex justify-center flex-col items-center gap-6 pt-4">
                <button onclick="check173WriteAI()" class="px-8 py-4 md:px-12 md:py-5 bg-sky-600 hover:bg-sky-700 text-white font-black rounded-2xl shadow-xl transition-all active:scale-[0.95] flex items-center justify-center gap-3 text-lg md:text-xl uppercase tracking-wider">
                    <span>🤖</span> 
                    <span>Nộp bài viết cho EduRobot</span>
                </button>
                <div id="fb-173-write-ai" class="w-full hidden mt-4"></div>
            </div>
        </div>
