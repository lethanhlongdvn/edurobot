...
window.submitVn86Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 86',
            '📝',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🎉</span><p class="text-2xl font-bold text-emerald-800">Chúc mừng em đã hoàn thành xuất sắc bài học Luyện tập về dấu gạch ngang!</p><p class="text-lg text-gray-700 mt-3">Hãy luôn ghi nhớ và sử dụng đúng dấu gạch ngang khi viết văn để câu văn mạch lạc, chuẩn ngữ pháp nhé!</p></div>'
        );
    } else {
