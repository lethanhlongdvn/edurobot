...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-indigo-50/70 p-6 md:p-8 rounded-[32px] border-l-8 border-indigo-600 shadow-lg relative overflow-hidden">
        ...
        <h3 class="text-2xl md:text-5xl font-black text-indigo-900 mb-4 flex items-center gap-3">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-indigo-100 shadow-xl space-y-6">
        <div class="flex items-center gap-4 mb-2">
            <div class="w-12 h-12 bg-indigo-600 text-white rounded-xl flex items-center justify-center text-2xl md:text-5xl font-black shadow-md">🎮</div>
        ...
        <div class="space-y-4">
            <textarea id="ans-vn81-kd" rows="3" placeholder="Ví dụ: Hồi nhỏ, em thường được bà ngoại kể cho nghe truyện Tấm Cám và Sự tích trầu cau vào mỗi tối trước khi đi ngủ..." class="w-full p-4 border-2 border-indigo-100 rounded-2xl outline-none focus:border-indigo-500 font-bold bg-indigo-50/10 text-xl md:text-2xl"></textarea>
            <div class="flex justify-center">
                <button onclick="kiemTraKhoiDong81()" class="px-8 py-3 bg-indigo-600 text-white font-black rounded-xl hover:bg-indigo-600 transition-all text-base shadow-md active:scale-95">GỬI Ý KIẾN ✓</button>
            </div>
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-indigo-100 pb-4">
            <h3 class="text-2xl md:text-5xl font-black text-indigo-800 flex items-center gap-3">
                <span class="p-2 bg-indigo-600 text-white rounded-xl shadow-md">📖</span>
        ...
        <div class="space-y-8">
            <div class="w-full bg-amber-50/20 p-6 md:p-10 rounded-[40px] border border-amber-100/55 shadow-inner relative overflow-hidden">
                ...
                <div onclick="window.showMathFeedback('Từ những câu chuyện ấu thơ', '🖼️', '&lt;div class=&quot;flex justify-center p-2&quot;&gt;&lt;img src=&quot;assets/images/tiengviet_5_1/81-82/81-82.png&quot; class=&quot;max-w-full max-h-[75vh] object-contain rounded-2xl shadow-2xl border-4 border-white&quot;&gt;&lt;/div&gt;')" class="float-none md:float-right mx-auto md:mx-0 md:ml-8 mb-6 w-full md:w-80 bg-white p-4 rounded-3xl border border-indigo-100 shadow-md cursor-pointer hover:scale-105 active:scale-95 transition-all overflow-hidden relative group border-4 border-white">
                    ...
                    <div class="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <span class="px-4 py-2 bg-white/95 rounded-full text-xs font-black text-indigo-800 shadow-md">🔍 PHÓNG TO</span>
                    </div>
                ...
                <div id="bai-doc-chuyen-au-tho" class="serif-font text-gray-800 leading-relaxed space-y-6 text-justify text-xl md:text-4xl">
                    <p class="indent-10">Tôi nghĩ trẻ em trên khắp thế giới đều thích nghe chuyện giống tôi. Ba tôi đi làm xa nên những câu chuyện đầu tiên tôi nghe được là từ bà tôi và chú tôi. Bà kể tôi nghe chuyện <span class="text-indigo-800 italic font-black">Tấm Cám, Thạch Sanh, Cây tre trăm đốt, Đôi hài bảy dặm</span>,... Chú tôi lại thích kể chuyện Tôn Ngộ Không và một số truyện trong <span class="text-indigo-800 italic font-black">Nghìn lẻ một đêm</span>.</p>
                    ...
                    <p class="indent-10">Bảy tuổi, tôi mê mẩn với những cuốn sách ba tôi mua về. Tám, chín tuổi, tôi đã mày mò đọc hết rương truyện Trung Hoa của ông thợ hớt tóc trong làng. Rồi tôi tìm đến <span class="text-indigo-800 italic font-black">Không gia đình, Những người khốn khổ</span>,…</p>
            ...
            <div class="grid grid-cols-1 gap-6">
                <!-- Chú giải từ khó -->
                <div class="bg-indigo-50/70 p-6 md:p-8 rounded-[28px] border-2 border-dashed border-indigo-200">
                    <p class="text-xs font-black text-indigo-600 uppercase tracking-widest mb-3 flex items-center gap-1">
                        <span>📝</span> Chú thích
                    </p>
                    <ul class="space-y-4 text-lg md:text-xl text-indigo-600 font-bold leading-relaxed">
    ...
    <div class="p-8 rounded-[36px] bg-gradient-to-r from-indigo-600 to-blue-500 text-white shadow-xl relative overflow-hidden mt-8">
...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-indigo-50">
        <div class="p-6 md:p-8 bg-indigo-50/30 rounded-[32px]">
            <div class="flex items-center gap-4 mb-8">
                <div class="w-12 h-12 bg-indigo-600 text-white rounded-xl flex items-center justify-center text-xl md:text-2xl font-black shadow-md">📖</div>
                <h3 class="text-2xl md:text-5xl font-black text-gray-800">Tìm hiểu bài</h3>
            </div>

            <div class="space-y-4">
                <!-- Câu 1 -->
                <details class="group bg-white rounded-2xl border border-indigo-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    <summary class="w-full p-6 text-left flex justify-between items-center cursor-pointer list-none hover:bg-indigo-50/50 transition-colors">
                        <span class="font-bold text-gray-800 group-hover:text-indigo-700 transition-colors text-lg md:text-3xl">
                            1. Những câu chuyện đầu tiên bạn nhỏ được nghe bà và chú kể là những câu chuyện gì?
                        </span>
                        <div class="w-8 h-8 rounded-full bg-indigo-50 flex items-center justify-center shrink-0 ml-4 group-open:rotate-180 transition-transform">
                            <svg class="w-4 h-4 text-indigo-800" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"></path></svg>
                        </div>
                    </summary>
                    <div class="px-8 pb-6 text-gray-800 leading-relaxed border-t border-indigo-50 pt-4 bg-indigo-50/10 font-medium text-lg md:text-3xl">
                        <p class="text-indigo-800 font-bold mb-2">💡 Gợi ý trả lời:</p>
                ...
                <details class="group bg-white rounded-2xl border border-indigo-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-8 pb-6 text-gray-800 leading-relaxed border-t border-indigo-50 pt-4 bg-indigo-50/10 font-medium text-lg md:text-3xl">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="font-bold text-indigo-800">Được bà và chú kể chuyện (lúc nhỏ) ➔ Mê mẩn sách ba mua về (7 tuổi) ➔ Đọc hết rương truyện Trung Hoa của ông thợ hớt tóc (8, 9 tuổi) ➔ Đọc Không gia đình, Những người khốn khổ...</p>
                        </div>
                    </div>
                </details>
    ...
    <section class="bg-white p-4 rounded-[40px] shadow-lg border border-amber-50">
        <div class="p-6 md:p-8 bg-amber-50/30 rounded-[32px]">
            ...
            <div class="bg-white p-6 rounded-3xl border border-amber-100 shadow-inner">
                ...
                <div id="fb-vn81-writing" class="hidden mt-6 p-6 bg-indigo-600 text-white rounded-2xl shadow-xl animate-in slide-in-from-top-10 duration-500">
    ...
    <div class="pt-6 flex justify-center">
        <button onclick="nopBai81Global()" class="px-12 py-5 bg-gradient-to-r from-indigo-600 to-blue-500 hover:scale-105 text-white font-black text-xl rounded-full shadow-xl transition-all active:scale-95 flex items-center gap-3">
...
window.checkWritingVn81 = function() {
    ...
    fb.innerHTML = `
        <div class="space-y-2">
            <span class="text-xs font-black text-indigo-800 block">🤖 ĐÁNH GIÁ TỪ THẦY E:</span>
            ...
            <span class="inline-block px-3 py-1 bg-white text-indigo-800 font-bold rounded-full shadow-sm mt-2 text-lg md:text-3xl">Đạt điểm tối đa bài tự luận cảm thụ</span>
        </div>
    `;
    fb.className = "p-5 rounded-2xl font-bold text-base bg-indigo-600 text-white shadow-xl border border-indigo-100 mt-2";
};
...
window.nopBai81Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 82',
            '📖',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">📚</span><p class="text-2xl md:text-3xl font-bold text-indigo-800">Chúc mừng em đã hoàn thành Tiết 82!</p><p class="text-lg text-gray-800 mt-3">Em đã nắm rõ khởi đầu hành trình yêu đọc sách của tác giả từ những câu chuyện ấu thơ. Hãy cùng bước sang Tiết 2 để tìm hiểu kỹ hơn về ý nghĩa của trang sách nhé!</p></div>'
        );
    }
};
