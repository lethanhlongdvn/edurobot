...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-blue-50/70 p-6 md:p-8 rounded-[32px] border-l-8 border-blue-600 shadow-md relative overflow-hidden">
        ...
        <ul class="space-y-3 text-blue-800 font-bold text-xl md:text-2xl ml-2">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6 relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-6">
            <div class="flex items-start gap-3 border-b border-blue-100 pb-4">
                ...
                <h3 class="text-2xl md:text-3xl font-black text-blue-800">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-4 space-y-4">
                    <div class="bg-blue-50/50 p-5 rounded-3xl border border-blue-100 space-y-4">
                        <span class="text-sm font-black text-blue-800 uppercase tracking-wider block">✍️ Câu hỏi Đọc hiểu</span>
...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <section class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="bg-gray-50 p-5 rounded-3xl border border-gray-100 space-y-3">
            <h4 class="font-black text-blue-800 text-xl md:text-2xl">a. Người viết muốn nói điều gì qua đoạn văn trên?</h4>
            <div class="grid grid-cols-1 gap-2.5 max-w-4xl">
                <label class="flex items-start gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-2xl border border-gray-100 cursor-pointer transition-all">
                    <input type="radio" name="q2-a" value="sai1" class="w-5 h-5 text-blue-800 mt-1 shrink-0">
                ...
                <label class="flex items-start gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-2xl border border-gray-100 cursor-pointer transition-all">
                    <input type="radio" name="q2-a" value="dung" class="w-5 h-5 text-blue-800 mt-1 shrink-0">
                ...
                <label class="flex items-start gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-2xl border border-gray-100 cursor-pointer transition-all">
                    <input type="radio" name="q2-a" value="sai2" class="w-5 h-5 text-blue-800 mt-1 shrink-0">
        ...
        <div class="bg-gray-50 p-5 rounded-3xl border border-gray-100 space-y-4">
            <h4 class="font-black text-blue-800 text-xl md:text-2xl">b. Nhấp chuột khám phá cấu trúc và nội dung tương ứng của mỗi phần:</h4>
        ...
        <div class="bg-gray-50 p-5 rounded-3xl border border-gray-100 space-y-4">
            <h4 class="font-black text-blue-800 text-xl md:text-2xl">c. Nhấp chọn các từ ngữ/câu văn biểu lộ tình cảm, cảm xúc của tác giả trong đoạn văn mẫu:</h4>
            ...
            <div class="flex justify-center gap-3 pt-3">
                <button id="btn-check-81-2" onclick="kiemTraCau2_80()" class="w-14 h-14 bg-blue-600 hover:bg-blue-600 text-white rounded-[1.5rem] font-black text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
    ...
    <section class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="space-y-6 max-w-4xl mx-auto pt-2">
            ...
            <div class="flex justify-center gap-3 pt-3">
                <button id="btn-check-81-3" onclick="kiemTraGhiNho80()" class="w-14 h-14 bg-blue-600 hover:bg-blue-600 text-white rounded-[1.5rem] font-black text-3xl shadow-lg transition-all active:scale-95 flex items-center justify-center">E</button>
            </div>
    ...
    <div class="pt-6 flex justify-center">
        <button onclick="nopBai80Global()" class="px-12 py-5 bg-gradient-to-r from-blue-600 to-indigo-500 hover:scale-105 text-white font-black text-xl rounded-full shadow-xl transition-all active:scale-95 flex items-center gap-3">
            <div class="w-6 h-6 bg-white rounded-lg flex items-center justify-center text-blue-900 font-black text-xs shadow-sm">✓</div>
...
window.chonKhoiDong80 = function(idx) {
    ...
    if (selBtn) {
        selBtn.className = "p-4 text-left font-black border-2 border-blue-100 bg-blue-600 text-blue-800 rounded-2xl text-lg md:text-xl transition-all shadow-md scale-[1.02]";
    }
...
window.nopBai80Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 81',
            '📝',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">📝</span><p class="text-2xl md:text-3xl font-bold text-blue-800">Chúc mừng em đã hoàn thành bài học hôm nay!</p><p class="text-lg text-gray-800 mt-3">Em đã nắm vững cấu trúc viết đoạn văn thể hiện tình cảm, cảm xúc rồi. Hãy sẵn sàng viết những dòng cảm xúc chân thực của riêng mình nhé.</p></div>'
        );
    }
};
