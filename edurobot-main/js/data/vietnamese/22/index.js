...
window.nopBaiVn22 = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback('Hoàn thành Tiết 22', '📻', '<div class="text-center p-6"><span class="text-7xl block mb-4">📻</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài đọc Bộ sưu tập độc đáo!</p><p class="text-lg text-gray-800 mt-3">Hãy luôn trân trọng tình cảm bạn bè và những giá trị kỷ niệm tinh thần quý giá xung quanh chúng ta.</p></div>');
    }
};
