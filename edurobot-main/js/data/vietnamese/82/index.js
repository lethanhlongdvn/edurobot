    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-blue-100 shadow-xl space-y-6">
        ...
        <div class="space-y-4 max-w-3xl mx-auto bg-amber-50/50 p-6 rounded-2xl border border-amber-100">
            <p class="text-xl md:text-2xl font-bold leading-relaxed text-gray-800">
                "Nhờ thói quen ấy, nhu cầu đọc sách đã <span class="text-blue-800 underline">nảy mầm</span> và trở thành một <input type="text" id="kd-83-input" placeholder="......" class="px-2 py-1 border-b-2 border-blue-100 outline-none w-28 text-center text-blue-800 bg-white rounded-md"> trong tôi, như cỏ cây khát ánh sáng và khí trời."
            </p>
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-blue-100 shadow-xl space-y-6">
        <div class="flex flex-col md:flex-row items-center gap-6 border-b border-blue-100 pb-4">
            ...
            <div onclick="window.showMathFeedback('Từ những câu chuyện ấu thơ', '🖼️', '&lt;div class=&amp;quot;flex justify-center p-2&amp;quot;&gt;&lt;img src=&amp;quot;assets/images/tiengviet_5_1/81-82/81-82.png&amp;quot; class=&amp;quot;max-w-full max-h-[75vh] object-contain rounded-2xl shadow-2xl border-4 border-white&amp;quot; /&gt;&lt;/div&gt;')" class="shrink-0 w-36 h-24 overflow-hidden rounded-2xl border-2 border-indigo-100 shadow cursor-pointer hover:scale-105 active:scale-95 transition-all relative group">
                ...
                <div class="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <span class="text-[8px] font-black text-white bg-indigo-600 px-1.5 py-0.5 rounded">🔍 Zoom</span>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-8 max-w-4xl mx-auto pt-2">
            ...
            <div class="space-y-3 p-6 bg-slate-50 rounded-2xl border border-slate-100">
                <p class="font-black text-blue-800 text-xl flex items-center gap-2">
                    <span class="w-8 h-8 rounded-full bg-blue-600 text-blue-800 flex items-center justify-center text-sm font-black shadow-inner">4</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q4-83" value="wrong1" class="w-5 h-5 text-blue-800">
                        <span class="text-base font-bold text-gray-800">Giúp bạn nhỏ học giỏi hơn và được thầy cô khen thưởng</span>
                    </label>
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q4-83" value="correct" class="w-5 h-5 text-blue-800">
                    ...
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q4-83" value="wrong2" class="w-5 h-5 text-blue-800">
                        <span class="text-base font-bold text-gray-800">Giúp bạn nhỏ giải trí, quên đi những giờ học tập căng thẳng</span>
                    </label>
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q4-83" value="wrong3" class="w-5 h-5 text-blue-800">
            ...
            <div class="space-y-3 p-6 bg-slate-50 rounded-2xl border border-slate-100">
                <p class="font-black text-blue-800 text-xl flex items-center gap-2">
                    <span class="w-8 h-8 rounded-full bg-blue-600 text-blue-800 flex items-center justify-center text-sm font-black shadow-inner">5</span>
                    Việc các em của bạn nhỏ rất háo hức được nghe anh kể chuyện thể hiện điều gì?
                </p>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q5-83" value="wrong1" class="w-5 h-5 text-blue-800">
                        <span class="text-base font-bold text-gray-800">Các em nhỏ không muốn tự mình tìm đọc sách truyện</span>
                    </label>
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q5-83" value="wrong2" class="w-5 h-5 text-blue-800">
                        <span class="text-base font-bold text-gray-800">Vì các em chưa đi học lớp Một nên bắt buộc phải nghe anh kể</span>
                    </label>
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q5-83" value="correct" class="w-5 h-5 text-blue-800">
                    ...
                    <label class="flex items-center gap-3 p-3 bg-white hover:bg-blue-50/20 rounded-xl border border-gray-100 cursor-pointer transition-all select-none">
                        <input type="radio" name="q5-83" value="wrong3" class="w-5 h-5 text-blue-800">
...
window.nopBai82Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 83',
            '📚',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🌟</span><p class="text-2xl md:text-3xl font-bold text-indigo-800">Chúc mừng em đã hoàn thành Tiết 83!</p><p class="text-lg text-gray-800 mt-3">Đọc sách bồi đắp tâm hồn, giúp ta khôn lớn từng ngày. Hãy biến việc đọc sách thành một thói quen tích cực hằng ngày như tác giả Nguyễn Nhật Ánh nhé!</p></div>'
        );
    }
};
