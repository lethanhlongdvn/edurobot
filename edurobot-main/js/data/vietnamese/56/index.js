...
window.submitVn56Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 56',
            '🎙️',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">🎙️</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành bài thực hành Nói và nghe!</p><p class="text-lg text-gray-800 mt-3">Sự tự tin thuyết trình trước đám đông và tình yêu đối với vẻ đẹp giang sơn tổ quốc sẽ nâng cánh cho em bay xa hơn nữa. Hãy tiếp tục phát huy nhé.</p></div>'
        );
    }
};
