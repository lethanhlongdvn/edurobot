...
<div class="space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-indigo-50/70 p-6 md:p-8 rounded-[32px] border-l-8 border-indigo-600 shadow-lg relative overflow-hidden">
        ...
        <ul class="space-y-3 text-indigo-800 font-bold text-lg md:text-xl ml-2">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-6">
        ...
        <div class="bg-indigo-50/70 p-6 rounded-2xl border-l-4 border-indigo-500 font-bold text-indigo-950 text-xl leading-relaxed italic text-center max-w-2xl mx-auto shadow-inner">
            "Có công mài sắt, có ngày nên kim."
        </div>
        <div class="max-w-md mx-auto space-y-4 pt-2">
            <input type="text" id="warmup-repetition-input" placeholder="Nhập từ được lặp lại nhiều nhất..." class="w-full p-4 border-2 border-indigo-100 rounded-2xl outline-none focus:border-indigo-500 font-bold bg-indigo-50/10 text-lg md:text-xl shadow-inner text-center">
            <div class="flex justify-center">
                <button onclick="startWarmupVn93()" class="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-lg rounded-2xl shadow active:scale-95 transition-all">KIỂM TRA ✉️</button>
            </div>
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-blue-500 text-white p-8 rounded-[48px] shadow-xl relative overflow-hidden">
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-8">
        <h3 class="text-2xl md:text-3xl font-black text-indigo-800 border-b border-indigo-100 pb-4 flex items-center gap-3">
            <span class="text-3xl">📝</span>
            Luyện tập thực hành
        </h3>
        ...
        <div class="space-y-4">
            <h4 class="text-xl font-black text-gray-800 flex items-start gap-2">
                <span class="w-7 h-7 rounded-full bg-indigo-100 text-indigo-800 flex items-center justify-center text-sm shrink-0 mt-0.5">1</span>
            ...
            <div class="bg-indigo-50/50 p-6 rounded-3xl border border-indigo-100 max-w-xl mx-auto shadow-inner select-none">
            ...
            <div class="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col justify-between gap-2">
                    <span class="font-black text-indigo-900">Từ "trông" xuất hiện mấy lần?</span>
                    <input type="number" id="vn93-c1-count" placeholder="Nhập số lần đếm được..." class="w-full p-2 border-2 border-indigo-100 rounded-xl font-bold bg-white outline-none focus:border-indigo-500">
                </div>
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col justify-between gap-2">
                    <span class="font-black text-indigo-900">Việc lặp lại từ "trông" có tác dụng gì?</span>
                    <select id="vn93-c1-effect" class="w-full p-2.5 border border-indigo-200 rounded-xl font-bold bg-white text-sm">
            ...
            <div class="flex justify-center pt-2">
                <button onclick="checkC1Vn93()" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black rounded-xl shadow active:scale-95 transition-all">NỘP BÀI ✓</button>
            </div>
        ...
        <div class="space-y-4 border-t border-indigo-50 pt-6">
            <h4 class="text-xl font-black text-gray-800 flex items-start gap-2">
                <span class="w-7 h-7 rounded-full bg-indigo-100 text-indigo-800 flex items-center justify-center text-sm shrink-0 mt-0.5">2</span>
                Đọc câu tục ngữ dưới đây và xác định từ lặp lại cùng tác dụng:
            </h4>
            <div class="bg-indigo-50/70 p-5 rounded-2xl border-l-4 border-indigo-500 font-bold text-indigo-950 text-xl leading-relaxed italic text-center max-w-xl mx-auto shadow-inner select-none">
                "Học ăn, học nói, học gói, học mở."
            </div>

            <div class="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col justify-between gap-2">
                    <span class="font-black text-indigo-900">Từ ngữ được lặp lại là:</span>
                    <input type="text" id="vn93-c2-word" placeholder="Nhập từ được lặp..." class="w-full p-2 border-2 border-indigo-100 rounded-xl font-bold bg-white text-center outline-none focus:border-indigo-500">
                </div>
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col justify-between gap-2">
                    <span class="font-black text-indigo-900">Tác dụng của việc lặp lại đó là gì?</span>
                    <select id="vn93-c2-effect" class="w-full p-2.5 border border-indigo-200 rounded-xl font-bold bg-white text-sm">
                        <option value="">-- Chọn tác dụng --</option>
            ...
            <div class="flex justify-center pt-2">
                <button onclick="checkC2Vn93()" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black rounded-xl shadow active:scale-95 transition-all">NỘP BÀI ✓</button>
            </div>
        ...
        <div class="space-y-4 border-t border-indigo-50 pt-6">
            <h4 class="text-xl font-black text-gray-800 flex items-start gap-2">
                <span class="w-7 h-7 rounded-full bg-indigo-100 text-indigo-800 flex items-center justify-center text-sm shrink-0 mt-0.5">3</span>
            ...
            <div class="max-w-2xl mx-auto bg-slate-50 p-5 rounded-2xl border border-slate-100 space-y-3 pt-2">
                <span class="font-black text-indigo-900">Từ "bỗng" được lặp lại 3 lần có tác dụng gì? (Chọn đáp án đúng của SGK)</span>
                <div class="space-y-2">
            ...
            <div class="flex justify-center pt-2">
                <button onclick="checkC3Vn93()" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black rounded-xl shadow active:scale-95 transition-all">NỘP BÀI ✓</button>
            </div>
        ...
        <div class="space-y-4 border-t border-indigo-50 pt-6">
            <h4 class="text-xl font-black text-gray-800 flex items-start gap-2">
                <span class="w-7 h-7 rounded-full bg-indigo-100 text-indigo-800 flex items-center justify-center text-sm shrink-0 mt-0.5">4</span>
                Đọc đoạn văn Thép Mới và đếm số từ "tre" lặp lại:
            </h4>
            
            <div class="bg-indigo-50/50 p-6 rounded-3xl border border-indigo-100 max-w-xl mx-auto shadow-inner select-none text-justify">
            ...
            <div class="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col justify-between gap-2">
                    <span class="font-black text-indigo-900">Từ "tre" xuất hiện bao nhiêu lần?</span>
                    <input type="number" id="vn93-c4-count" placeholder="Nhập số lần đếm được..." class="w-full p-2 border-2 border-indigo-100 rounded-xl font-bold bg-white outline-none focus:border-indigo-500">
                </div>
                <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col justify-between gap-2">
                    <span class="font-black text-indigo-900">Tác dụng của việc điệp từ "tre" là gì?</span>
                    <select id="vn93-c4-effect" class="w-full p-2.5 border border-indigo-200 rounded-xl font-bold bg-white text-sm">
                        <option value="">-- Chọn tác dụng --</option>
            ...
            <div class="flex justify-center pt-2">
                <button onclick="checkC4Vn93()" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black rounded-xl shadow active:scale-95 transition-all">NỘP BÀI ✓</button>
            </div>
    ...
    <div class="bg-white p-6 md:p-10 rounded-[48px] border border-indigo-100 shadow-xl space-y-6">
        ...
        <div class="space-y-4 max-w-4xl mx-auto pt-2">
            <textarea id="vn93-essay-input" rows="4" placeholder="Ví dụ: Em yêu cánh đồng quê, yêu hàng tre xanh mát, yêu cả những buổi chiều hoàng hôn tĩnh lặng..." class="w-full p-4 border-2 border-indigo-100 rounded-3xl outline-none focus:border-indigo-500 font-bold bg-indigo-50/10 text-lg md:text-xl shadow-inner"></textarea>
            
            <div class="flex justify-center gap-3">
                <button onclick="checkWritingVn93()" class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-black text-lg rounded-2xl shadow-lg hover:shadow-xl active:scale-95 transition-all flex items-center gap-2">
                    <span>🎓</span> CHẤM ĐIỂM AI THẦY E
                </button>
                <button onclick="resetVn93()" class="px-6 py-4 bg-gray-200 hover:bg-gray-300 text-gray-700 font-black text-lg rounded-2xl active:scale-95 transition-all">LÀM LẠI</button>
            </div>
