...
<div class="space-y-12 animate-in fade-in duration-700 max-w-6xl mx-auto">
    ...
    <div class="bg-white p-6 md:p-8 rounded-[36px] border border-sky-100 shadow-xl space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 font-bold text-center">
            ...
            <div onclick="copTimeline36('Năm 2014, Sơn Đoòng được bình chọn là một trong 52 điểm du lịch hấp dẫn nhất thế giới.')" class="p-4 bg-blue-50 hover:bg-blue-600 rounded-2xl border border-blue-100 cursor-pointer text-blue-800 transition-all active:scale-95">
                <span class="block text-blue-900 font-black text-xl mb-1">📅 Năm 2014</span>
