...
<div class="space-y-8 animate-fade-in pb-10">
    ...
    <div class="bg-emerald-50 p-8 rounded-[48px] border-l-8 border-emerald-600 shadow-xl relative overflow-hidden">
        ...
        <h3 class="text-3xl font-black text-emerald-900 mb-6 flex items-center gap-4">
    ...
    <div class="p-10 rounded-[48px] bg-gradient-to-r from-emerald-600 to-teal-500 text-white shadow-2xl relative overflow-hidden">
        ...
        <h4 class="text-2xl font-black uppercase tracking-widest mb-6 opacity-80 flex items-center gap-3">
...
<div class="space-y-16 animate-fade-in pb-12">
    ...
    <section class="bg-white p-4 rounded-[64px] shadow-2xl border border-emerald-50 overflow-hidden" id="ex-vn-template-1">
        <div class="p-4 md:p-7 bg-emerald-50/50 rounded-[56px]">
            <div class="flex items-start gap-6 mb-10">
                <div class="w-16 h-16 bg-emerald-600 text-white rounded-[24px] flex items-center justify-center text-3xl font-black shadow-lg shadow-emerald-200">📖</div>
            ...
            <div class="space-y-4">
                ...
                <details class="group bg-white/50 rounded-[24px] border border-gray-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-gray-100 pt-4 bg-emerald-50/30">
                        <p class="font-medium">[Gợi ý trả lời câu 1...]</p>
                    </div>
                </details>
                ...
                <details class="group bg-white/50 rounded-[24px] border border-gray-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-gray-100 pt-4 bg-emerald-50/30">
                        <p class="font-medium">[Gợi ý trả lời câu 2...]</p>
                    </div>
                </details>
                ...
                <details class="group bg-white/50 rounded-[24px] border border-gray-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-gray-100 pt-4 bg-emerald-50/30">
                        <p class="font-medium">[Gợi ý trả lời câu 3...]</p>
                    </div>
                </details>
                ...
                <details class="group bg-white/50 rounded-[24px] border border-gray-100 shadow-sm transition-all hover:shadow-md overflow-hidden">
                    ...
                    <div class="px-6 pb-6 text-gray-600 leading-relaxed border-t border-gray-100 pt-4 bg-emerald-50/30">
                        <p class="font-medium">[Gợi ý trả lời câu 4...]</p>
                    </div>
                </details>
            </div>
        </div>
    ...
    <section class="bg-white p-4 rounded-[64px] shadow-2xl border border-amber-50 overflow-hidden" id="ex-vn-template-2">
        <div class="p-8 md:p-14 bg-amber-50/50 rounded-[56px]">
            <div class="flex items-start gap-6 mb-10">
                <div class="w-16 h-16 bg-amber-500 text-white rounded-[24px] flex items-center justify-center text-3xl font-black shadow-lg shadow-amber-200">✏️</div>
                <h3 class="text-3xl md:text-4xl font-black text-gray-800 leading-tight">
                    Luyện viết
                </h3>
            </div>
            ...
            <div class="bg-white p-10 rounded-[48px] border-[6px] border-amber-200/50 shadow-2xl flex flex-col relative">
                ...
                <div class="relative flex-grow">
                    <textarea id="ans-vn-template-writing" rows="8" class="w-full p-8 pr-20 rounded-[32px] border-4 border-amber-100 bg-amber-50/30 outline-none focus:border-amber-400 text-2xl font-bold text-gray-800 transition-all shadow-inner resize-none leading-relaxed" placeholder="Em hãy viết bài tại đây..."></textarea>
                ...
                <div class="mt-8 flex flex-wrap items-center gap-6">
                    <button id="btn-submit-vn-template-writing" onclick="window.submitVnTemplateEx('writing')" class="px-10 py-5 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-2xl rounded-[24px] shadow-xl transition-all active:scale-95 flex items-center gap-3">
                    ...
                    <button onclick="Lesson.submitWordProblemAI('vn-template-writing')" class="px-12 py-5 bg-amber-500 hover:bg-amber-600 text-white font-black text-2xl rounded-[24px] shadow-xl shadow-amber-200 transition-all active:scale-95 flex items-center gap-4">
                        Kiểm tra với Thầy E <span class="bg-white/20 p-1 rounded-lg italic text-lg">AI</span>
                    </button>
                    <div id="fb-vn-template-writing" class="text-2xl font-black opacity-0 flex items-center gap-2"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="pt-10 flex justify-center">
        <button onclick="window.submitVnStandardLesson('[Tên bài học]', 100)" class="px-16 py-6 bg-gradient-to-r from-emerald-600 to-teal-700 hover:scale-105 text-white font-black text-2xl rounded-[32px] shadow-2xl transition-all active:scale-95 flex items-center gap-4 group">
