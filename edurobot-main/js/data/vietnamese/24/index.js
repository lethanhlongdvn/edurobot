...
window.submitVn24Global = function() {
    if (typeof window.showMathFeedback === 'function') {
        window.showMathFeedback(
            'Hoàn thành Tiết 24',
            '📝',
            '<div class="text-center p-6"><span class="text-7xl block mb-4">📝</span><p class="text-2xl font-bold text-sky-800">Chúc mừng em đã hoàn thành xuất sắc bài học Viết báo cáo công việc!</p><p class="text-2xl md:text-3xl text-gray-800 mt-3">Một báo cáo mạch lạc, rõ ràng và đầy đủ số liệu là chìa khóa của sự chuyên nghiệp trong công việc và học tập tập thể.</p></div>'
        );
    }
};
